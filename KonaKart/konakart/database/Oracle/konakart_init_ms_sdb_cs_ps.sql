...
-- Created: Wed Jan 18 04:55:12 GMT 2017
-- -----------------------------------------------------------
-- 
set escape \
-- version 2.1 of the License, or (at your option) any later version.
...
-- Created: Wed Jan 18 04:55:02 GMT 2017
-- -----------------------------------------------------------
--
...
UPDATE orders_status SET store_id = 'store1';
UPDATE kk_content_type SET store_id = 'store1';
UPDATE kk_content_type_desc SET store_id = 'store1';
UPDATE kk_content SET store_id = 'store1';
UPDATE kk_content_desc SET store_id = 'store1';
UPDATE kk_catalog_to_category SET store_id = 'store1';
UPDATE kk_filter SET store_id = 'store1';
UPDATE kk_reserved_stock SET store_id = 'store1';
UPDATE kk_credit_card SET store_id = 'store1';
exit;
