...
-- Created: Wed Jan 18 04:55:09 GMT 2017
-- -----------------------------------------------------------
-- 
set escape \
...
UPDATE configuration set configuration_value = 'C:/Program Files/KonaKart/database/Oracle/konakart_new_store_ps.sql' where configuration_key = 'KK_NEW_STORE_SQL_FILENAME';
