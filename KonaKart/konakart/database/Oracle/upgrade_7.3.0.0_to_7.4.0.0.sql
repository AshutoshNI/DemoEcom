...
set echo on
INSERT INTO kk_config (kk_config_id, kk_config_key, kk_config_value, date_added) VALUES (kk_config_seq.nextval, 'HISTORY', '7.4.0.0 U', sysdate);
UPDATE kk_config SET kk_config_value='7.4.0.0 Oracle', date_added=sysdate WHERE kk_config_key='VERSION';
...
INSERT INTO kk_content_type (id, content_type_id, date_added, store_id) SELECT kk_content_type_seq.nextval, 1, sysdate, store_id FROM kk_store;
INSERT INTO kk_content_type (id, content_type_id, date_added, store_id) SELECT kk_content_type_seq.nextval, 2, sysdate, store_id FROM kk_store;
INSERT INTO kk_content_type (id, content_type_id, date_added, store_id) SELECT kk_content_type_seq.nextval, 3, sysdate, store_id FROM kk_store;
INSERT INTO kk_content_type (id, content_type_id, date_added, store_id) SELECT kk_content_type_seq.nextval, 4, sysdate, store_id FROM kk_store;
INSERT INTO kk_content_type (id, content_type_id, date_added, store_id) SELECT kk_content_type_seq.nextval, 5, sysdate, store_id FROM kk_store;

INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added, store_id) SELECT kk_content_type_desc_seq.nextval, 1, languages_id, 'Top Banner', 'Top Banner - Top of store home page', sysdate, KKS.store_id FROM kk_store KKS, languages L WHERE KKS.store_id=L.store_id OR L.store_id is null OR L.store_id='';
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added, store_id) SELECT kk_content_type_desc_seq.nextval, 2, languages_id, 'Sub Banner', 'Sub Banner - Secondary banner', sysdate, KKS.store_id FROM kk_store KKS, languages L WHERE KKS.store_id=L.store_id OR L.store_id is null OR L.store_id='';
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added, store_id) SELECT kk_content_type_desc_seq.nextval, 3, languages_id, 'Category Banner', 'Category Banner - Top of category pages', sysdate, KKS.store_id FROM kk_store KKS, languages L WHERE KKS.store_id=L.store_id OR L.store_id is null OR L.store_id='';
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added, store_id) SELECT kk_content_type_desc_seq.nextval, 4, languages_id, 'Category Sub Banner', 'Category Sub Banner - Secondary Category Banner', sysdate, KKS.store_id FROM kk_store KKS, languages L WHERE KKS.store_id=L.store_id OR L.store_id is null OR L.store_id='';
