...
-- 
-- -----------------------------------------------------------
-- KonaKart v8.5.0.0 demo database script for DB2
-- Created: Wed Jan 18 04:55:19 GMT 2017
-- -----------------------------------------------------------
-- 
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES (nextval for configuration_seq, 'Use Solr Search Server','USE_SOLR_SEARCH','false','Use Solr search server to search for products',24, 1, 'choice(''true''=''true'',''false''=''false'')', current timestamp);
DELETE FROM configuration WHERE configuration_key = 'SOLR_URL';
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES (nextval for configuration_seq, 'Base URL of Solr Search Server','SOLR_URL','http://localhost:8983/solr/konakart','Base URL of Solr Search Server',24, 2, current timestamp);
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES (nextval for configuration_seq, 'Delete from index on commit','SOLR_DELETE_ON_COMMIT','true','On commit, delete from index products marked for deletion',24, 5, 'choice(''true''=''true'',''false''=''false'')', current timestamp, 0);
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 1, 3, 'Top Banner', 'Top Banner - Inicio de tienda de la página principal', current date);
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 2, 2, 'Sub Banner', 'Sub Banner - Sekundär banner', current date);
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 2, 4, 'Sub Banner', 'Sub Banner - bandeira Secundário', current date);
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 3, 3, 'Categoria Banner', 'Categoría Banner - Inicio de las páginas de categorías', current date);
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 3, 4, 'Categoria Banner', 'Categoria Banner - Top de páginas da categoria', current date);
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 4, 2, 'Kategorie Unter Banner', 'Kategorie Unter Banner - Sekundäre Kategorie Banner', current date);
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 4, 3, 'Categoría Sub Banner', 'Categoría Sub Banner - Categoría Secundaria Banner', current date);
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 4, 4, 'Categoría Sub Banner', 'Categoria Sub Banner - Categoria Secundária Bandeira', current date);
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 5, 2, 'über uns', 'über uns', current date);
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 5, 4, 'sobre nós', 'sobre nós', current date);
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 6, 3, 'Envío y manipulación', 'Envío y manipulación', current date);
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 6, 4, 'Envio e manipulação', 'Envio e manipulação', current date);
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 7, 2, 'Produktrückgabe', 'Produktrückgabe', current date);
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 7, 3, 'Devolución de productos', 'Devolución de productos', current date);
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 7, 4, 'Devoluções de produtos', 'Devoluções de produtos', current date);
...
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 9, 3, 'Política de privacidad', 'política de privacidad', current date);
INSERT INTO kk_content_type_desc (id, content_type_id, language_id, content_type_name, description, date_added) VALUES (NEXTVAL FOR kk_content_type_desc_seq, 9, 4, 'Política De Privacidade', 'Política De Privacidade', current date);
...
INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 16, 1, 'SelectProd.action?prodId={OBJ_ID}', 34, 1, 1, 2, current date, current date);
...
INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 17, 1, 'SelectProd.action?prodId={OBJ_ID}', 33, 1, 1, 2, current date, current date);
...
INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 18, 2, 'ShowSpecials.action', 0, 0, 1, 2, current date, current date);
...
INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 19, 2, 'SelectCat.action?catId={OBJ_ID}', 23, 2, 1, 2, current date, current date);
...
INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 20, 2, 'SelectCat.action?catId={OBJ_ID}', 24, 2, 1, 2, current date, current date);
...
INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 21, 2, 'SelectProd.action?prodId={OBJ_ID}', 32, 1, 1, 2, current date, current date);
...
INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 22, 2, 'SelectProd.action?prodId={OBJ_ID}', 35, 1, 1, 2, current date, current date);
...
INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 23, 5, '', 0, 0, 1, 2, current date, current date);
...
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 23, 2, 'Fügen Sie Ihre Über uns Informationen hier', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 23, 3, 'Añade tu Quiénes somos información aquí', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 23, 4, 'Adicione a sua Quem somos informações aqui', current date);

INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 24, 6, '', 0, 0, 1, 2, current date, current date);
...
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 24, 2, 'Fügen Sie Ihre Versandinformationen hier', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 24, 3, 'Agregue su envío y manipulación de información aquí', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 24, 4, 'Adicione sua informação de envio aqui', current date);

INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 25, 7, '', 0, 0, 1, 2, current date, current date);
...
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 25, 2, 'Fügen Sie Ihre Versandkosten Informationen finden Sie hier', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 25, 3, 'Añade tu información Devoluciones aquí', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 25, 4, 'Adicione sua informação Returns aqui', current date);

INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 26, 8, '', 0, 0, 1, 2, current date, current date);
...
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 26, 2, 'Fügen Sie hier Ihre Informationen Internationale Bestellungen.', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 26, 3, 'Añade tu información Internacional Órdenes aquí.', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 26, 4, 'Adicione sua informação Internacional Ordens aqui.', current date);

INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 27, 9, '', 0, 0, 1, 2, current date, current date);
...
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 27, 2, 'Fügen Sie Ihren Datenschutz hier.', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 27, 3, 'Agregue su política de privacidad aquí.', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 27, 4, 'Adicione a sua Política de Privacidade aqui.', current date);

INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 28, 10, '', 0, 0, 1, 2, current date, current date);
...
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 28, 2, 'Fügen Sie Ihr Nutzungsbedingungen hier', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 28, 3, 'Añada sus Términos de Uso aquí', current date);
...
INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 29, 11, '', 0, 0, 1, 2, current date, current date);
...
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 29, 2, 'Fügen Sie hier Ihre Informationen Hilfe.', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 29, 3, 'Añade tu información de ayuda aquí.', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 29, 4, 'Adicione sua informação ajuda aqui.', current date);

INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 30, 12, '', 0, 0, 1, 2, current date, current date);
...
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 30, 2, 'Fügen Sie Ihre Kontaktinformationen hier', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 30, 3, 'Añadir su información de contacto aquí', current date);
INSERT INTO kk_content_desc (id, content_id, language_id, content, date_added) VALUES (NEXTVAL FOR kk_content_desc_seq, 30, 4, 'Adicione sua informação de contato aqui', current date);
...
-- Logo Image
INSERT INTO kk_content (id, content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (NEXTVAL FOR kk_content_seq, 31, 13, 'Welcome.action', -1, -1, 1, 2, current date, current date);
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES (nextval for configuration_seq, 'Add suggested search for catalog','SOLR_ADD_TERM_FOR_CATALOG','false','Adds a suggested search list for each catalog id since the catalog may contain only a subset of products',24, 30, 'choice(''true''=''true'',''false''=''false'')', current timestamp, 1);

DELETE FROM configuration WHERE configuration_key = 'SOLR_ADD_SPELLING_FOR_CATALOG';
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES (nextval for configuration_seq, 'Add spelling suggestions for catalog','SOLR_ADD_SPELLING_FOR_CATALOG','false','Adds spelling suggestions for each catalog id since the catalog may contain only a subset of products',24, 32, 'choice(''true''=''true'',''false''=''false'')', current timestamp, 1);

DELETE FROM configuration WHERE configuration_key = 'SOLR_CATALOG_USED_FOR_PRICE';
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES (nextval for configuration_seq, 'Catalogs used for product prices','SOLR_CATALOG_USED_FOR_PRICE','false','Set to true if catalogs are used to determine product prices',24, 34, 'choice(''true''=''true'',''false''=''false'')', current timestamp, 0);

DELETE FROM configuration WHERE configuration_key = 'SOLR_CATALOG_USED_FOR_QTY';
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES (nextval for configuration_seq, 'Catalogs used for product quantities','SOLR_CATALOG_USED_FOR_QTY','false','Set to true if catalogs are used to determine product quantities',24, 36, 'choice(''true''=''true'',''false''=''false'')', current timestamp, 0);
...
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (nextval for countries_seq,'Åland Islands','AX','ALA',1, '248');
...
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (nextval for countries_seq,'Saint Barthélemy','BL','BLM',1, '652');
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (nextval for orders_status_seq,11,(SELECT languages_id FROM languages WHERE code = 'de'),'Warten auf die Bestätigung');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (nextval for orders_status_seq,11,(SELECT languages_id FROM languages WHERE code = 'es'),'A la espera de la aprobación');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (nextval for orders_status_seq,11,(SELECT languages_id FROM languages WHERE code = 'pt'),'Esperando aprovação');
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (nextval for orders_status_seq,13,(SELECT languages_id FROM languages WHERE code = 'de'),'Approval Abgelehnt');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (nextval for orders_status_seq,13,(SELECT languages_id FROM languages WHERE code = 'es'),'Se rechaza la aprobación');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (nextval for orders_status_seq,13,(SELECT languages_id FROM languages WHERE code = 'pt'),'Aprovação Recusado');
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api, store_id) SELECT nextval for configuration_seq, 'ERP Integration Enabled?', 'ERP_INT_INTEGRATION_ENABLED', CONCAT(configuration_value, 'false'), 'Set to true to enable ERP Integration', 32, 5, 'choice(''true''=''true'',''false''=''false'')', current timestamp, 1, store_id FROM configuration WHERE configuration_key = 'INSTALLATION_HOME';
...
INSERT INTO kk_config (kk_config_id, kk_config_key, kk_config_value, date_added) VALUES (NEXTVAL FOR kk_config_seq, 'HISTORY', '8.5.0.0 I', current timestamp);
INSERT INTO kk_config (kk_config_id, kk_config_key, kk_config_value, date_added) VALUES (NEXTVAL FOR kk_config_seq, 'VERSION', '8.5.0.0 DB2', current timestamp);
