...
DELETE FROM kk_catalog_to_category;
DELETE FROM kk_category_to_tag_group;
DELETE FROM kk_config;
DELETE FROM kk_content;
DELETE FROM kk_content_desc;
DELETE FROM kk_content_type;
DELETE FROM kk_content_type_desc;
DELETE FROM kk_cookie;
DELETE FROM kk_credit_card;
