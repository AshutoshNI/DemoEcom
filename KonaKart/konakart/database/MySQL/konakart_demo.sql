#----------------------------------------------------------
# KonaKart v8.5.0.0 demo database script for MySQL database
#----------------------------------------------------------
#
# Note: 
...
CREATE TABLE customers (
   ...
   customers_dob datetime DEFAULT '1800-01-01 00:00:00' NOT NULL,
...
ALTER TABLE kk_content_type ADD KEY idx_content_type_id (content_type_id);
...
ALTER TABLE kk_content_type_desc ADD KEY idx_content_type_id (content_type_id);
...
ALTER TABLE kk_content ADD KEY idx_content_id (content_id);
ALTER TABLE kk_content ADD KEY idx_search_key (search_key);
...
ALTER TABLE kk_content_desc ADD KEY idx_content_id (content_id);
...
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getContents', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getContent', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('insertContent', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteContent', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('updateContent', '', now());

INSERT INTO kk_api_call (name, description, date_added) VALUES ('getContentTypes', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getContentType', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('insertContentType', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteContentType', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('updateContentType', '', now());
...
#MySQL -- Set the SearchKey in the categories table
UPDATE categories C,categories_description CD SET search_key = CD.categories_name WHERE C.categories_id = CD.categories_id AND CD.language_id IN (SELECT languages_id FROM languages L, configuration CON WHERE code=configuration_value AND configuration_key='DEFAULT_LANGUAGE');
#PostgreSQL UPDATE categories C SET search_key = CD.categories_name FROM categories_description CD WHERE C.categories_id = CD.categories_id AND CD.language_id IN (SELECT languages_id FROM languages L, configuration CON WHERE code=configuration_value AND configuration_key='DEFAULT_LANGUAGE');
#Oracle UPDATE categories C SET search_key = (SELECT categories_name FROM categories_description CD WHERE C.categories_id = CD.categories_id AND CD.language_id IN (SELECT languages_id FROM languages L, configuration CON WHERE code=configuration_value AND configuration_key='DEFAULT_LANGUAGE'));
#DB2 UPDATE categories C SET search_key = (SELECT CD.categories_name FROM categories_description CD WHERE C.categories_id = CD.categories_id AND CD.language_id IN (SELECT languages_id FROM languages L, configuration CON WHERE code=configuration_value AND configuration_key='DEFAULT_LANGUAGE'));
#MSSQL UPDATE categories SET search_key = categories_name FROM categories_description CD, categories C WHERE C.categories_id = CD.categories_id AND CD.language_id IN (SELECT languages_id FROM languages L, configuration CON WHERE code=configuration_value AND configuration_key='DEFAULT_LANGUAGE');
...
UPDATE configuration SET configuration_value = 'C:/KonaKart/database/MySQL/konakart_new_store.sql' WHERE configuration_key = 'KK_NEW_STORE_SQL_FILENAME';
UPDATE configuration SET configuration_value = 'C:/KonaKart/database/MySQL/konakart_user_new_store.sql' WHERE configuration_key = 'USER_NEW_STORE_SQL_FILENAME';
...
INSERT INTO prod_opt_vals_to_prod_opt (prod_opt_vals_to_prod_opt_id, products_options_id, products_options_values_id) VALUES (13, 1, 13);
INSERT INTO prod_opt_vals_to_prod_opt (prod_opt_vals_to_prod_opt_id, products_options_id, products_options_values_id) VALUES (14, 1, 14);
INSERT INTO prod_opt_vals_to_prod_opt (prod_opt_vals_to_prod_opt_id, products_options_id, products_options_values_id) VALUES (15, 1, 15);

UPDATE products_options SET code = 'COL' WHERE products_options_id = '1';

# Add color attributes to Brabantia Bin product
INSERT INTO products_attributes (products_attributes_id, products_id, options_id, options_values_id, options_values_price, price_prefix, sort_order) VALUES (15,44,1,13,0.00,'+',1);
INSERT INTO products_attributes (products_attributes_id, products_id, options_id, options_values_id, options_values_price, price_prefix, sort_order) VALUES (16,44,1,14,0.00,'+',0);
INSERT INTO products_attributes (products_attributes_id, products_id, options_id, options_values_id, options_values_price, price_prefix, sort_order) VALUES (17,44,1,15,0.00,'+',2);
...
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (240,'Åland Islands','AX','ALA',1, '248');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (241,'Guernsey','GG','GGY',1, '831');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (242,'Montenegro','ME','MNE',1, '499');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (243,'Palestine','PS','PSE',1, '275');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (244,'Saint Barthélemy','BL','BLM',1, '652');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (245,'Saint Helena, Ascension and Tristan da Cunha','SH','SHN',1, '654');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (246,'Saint Martin (French part)','MF','MAF',1, '663');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (247,'Saint Pierre and Miquelon','PM','SPM',1, '666');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (248,'Sint Maarten (Dutch part)','SX','SXM',1, '534');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (249,'South Sudan','SS','SSD',1, '728');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (250,'Timor-Leste','TL','TLS',1, '626');
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (41,11,(SELECT languages_id FROM languages WHERE code = 'en'),'Waiting for Approval');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (42,11,(SELECT languages_id FROM languages WHERE code = 'de'),'Warten auf die Bestätigung');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (43,11,(SELECT languages_id FROM languages WHERE code = 'es'),'A la espera de la aprobación');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (44,11,(SELECT languages_id FROM languages WHERE code = 'pt'),'Esperando aprovação');

# New order state - Approved
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (45,12,(SELECT languages_id FROM languages WHERE code = 'en'),'Approved');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (46,12,(SELECT languages_id FROM languages WHERE code = 'de'),'Genehmigt');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (47,12,(SELECT languages_id FROM languages WHERE code = 'es'),'Aprobado');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (48,12,(SELECT languages_id FROM languages WHERE code = 'pt'),'Aprovado');

# New order state - Approval Declined
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (49,13,(SELECT languages_id FROM languages WHERE code = 'en'),'Approval Declined');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (50,13,(SELECT languages_id FROM languages WHERE code = 'de'),'Approval Abgelehnt');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (51,13,(SELECT languages_id FROM languages WHERE code = 'es'),'Se rechaza la aprobación');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (52,13,(SELECT languages_id FROM languages WHERE code = 'pt'),'Aprovação Recusado');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api, store_id) SELECT 'ERP Integration Enabled?', 'ERP_INT_INTEGRATION_ENABLED', CONCAT(configuration_value, 'false'), 'Set to true to enable ERP Integration', '32', '5', 'choice(\'true\'=\'true\',\'false\'=\'false\')', now(), '1', store_id FROM configuration WHERE configuration_key = 'INSTALLATION_HOME';
...
ALTER TABLE configuration ADD KEY idx_conf_key (configuration_key);
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (53,14,(SELECT languages_id FROM languages WHERE code = 'en'),'Archived');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (54,14,(SELECT languages_id FROM languages WHERE code = 'de'),'Archivierte');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (55,14,(SELECT languages_id FROM languages WHERE code = 'es'),'Archivado');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (56,14,(SELECT languages_id FROM languages WHERE code = 'pt'),'Arquivado');
...
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('VERSION', '8.5.0.0 MySQL', now());
...
ALTER TABLE kk_reserved_stock ADD KEY idx_reservation_id (reservation_id);

# For specifying whether or not customer tags can be set using KKEngIf API calls
ALTER TABLE kk_customer_tag ADD set_by_api int(1) NOT NULL DEFAULT 0;
...
# New API call
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteProdAttrDescWithOptions', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteProducts', '', now());
...
CREATE TABLE kk_credit_card (
   kk_credit_card_id int NOT NULL auto_increment,
   store_id varchar(64),
   customers_id int NOT NULL,
   address_id int,
   ccType varchar(32),
   ...
   KEY idx_credit_card_customers_id (customers_id)
);
...
# New API call
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getStoreTime', '', now());
