#----------------------------------------------------------------
# KonaKart upgrade script from version 8.3.0.0 to version 8.5.0.0
#----------------------------------------------------------------
#
...
UPDATE kk_config SET kk_config_value='8.5.0.0 MySQL', date_added=now() WHERE kk_config_key='VERSION';
