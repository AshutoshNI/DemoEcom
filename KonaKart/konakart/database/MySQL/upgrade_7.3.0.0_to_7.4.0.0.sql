#----------------------------------------------------------------
# KonaKart upgrade script from version 7.3.0.0 to version 7.4.0.0
#----------------------------------------------------------------
#
...
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('HISTORY', '7.4.0.0 U', now());
UPDATE kk_config SET kk_config_value='7.4.0.0 MySQL', date_added=now() WHERE kk_config_key='VERSION';
...
INSERT INTO kk_content_type (content_type_id, date_added, store_id) SELECT 1, now(), store_id FROM kk_store;
INSERT INTO kk_content_type (content_type_id, date_added, store_id) SELECT 2, now(), store_id FROM kk_store;
INSERT INTO kk_content_type (content_type_id, date_added, store_id) SELECT 3, now(), store_id FROM kk_store;
INSERT INTO kk_content_type (content_type_id, date_added, store_id) SELECT 4, now(), store_id FROM kk_store;
INSERT INTO kk_content_type (content_type_id, date_added, store_id) SELECT 5, now(), store_id FROM kk_store;

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added, store_id) SELECT 1, languages_id, 'Top Banner', 'Top Banner - Top of store home page', now(), KKS.store_id FROM kk_store KKS, languages L WHERE KKS.store_id=L.store_id OR L.store_id is null OR L.store_id='';
...
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added, store_id) SELECT 2, languages_id, 'Sub Banner', 'Sub Banner - Secondary banner', now(), KKS.store_id FROM kk_store KKS, languages L WHERE KKS.store_id=L.store_id OR L.store_id is null OR L.store_id='';
...
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added, store_id) SELECT 3, languages_id, 'Category Banner', 'Category Banner - Top of category pages', now(), KKS.store_id FROM kk_store KKS, languages L WHERE KKS.store_id=L.store_id OR L.store_id is null OR L.store_id='';
...
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added, store_id) SELECT 4, languages_id, 'Category Sub Banner', 'Category Sub Banner - Secondary Category Banner', now(), KKS.store_id FROM kk_store KKS, languages L WHERE KKS.store_id=L.store_id OR L.store_id is null OR L.store_id='';
