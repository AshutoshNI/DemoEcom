...
UPDATE configuration set configuration_value = 'C:/Program Files/KonaKart/database/PostgreSQL/konakart_new_store_ps.sql' where configuration_key = 'KK_NEW_STORE_SQL_FILENAME';
