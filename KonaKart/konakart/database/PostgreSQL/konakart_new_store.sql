...
-- Created: Wed Jan 18 04:55:04 GMT 2017
-- -----------------------------------------------------------
-- 
...
delete from countries where store_id = 'TARGET_STOREID';
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, store_id) VALUES (DEFAULT, 'United States', 'US', 'USA', -1, 'TARGET_STOREID');
