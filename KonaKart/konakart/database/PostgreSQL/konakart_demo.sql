...
-- 
-- -----------------------------------------------------------
-- KonaKart v8.5.0.0 demo database script for PostgreSQL
-- Created: Wed Jan 18 04:55:03 GMT 2017
-- -----------------------------------------------------------
-- 
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Prices with Tax', 'DISPLAY_PRICE_WITH_TAX', 'false', 'Display prices with tax included (true) or add the tax at the end (false)', '1', '21', 'choice(''true''=''true'',''false''=''false'')', now());
...
-- 5
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Gender', 'ACCOUNT_GENDER', 'true', 'Display gender in the customers account', '5', '1', 'choice(''true''=''true'',''false''=''false'')', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Date of Birth', 'ACCOUNT_DOB', 'true', 'Display date of birth in the customers account', '5', '2', 'choice(''true''=''true'',''false''=''false'')', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Company', 'ACCOUNT_COMPANY', 'true', 'Display company in the customers account', '5', '3', 'choice(''true''=''true'',''false''=''false'')', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Suburb', 'ACCOUNT_SUBURB', 'true', 'Display suburb in the customers account', '5', '4', 'choice(''true''=''true'',''false''=''false'')', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('State', 'ACCOUNT_STATE', 'true', 'Display state in the customers account', '5', '5', 'choice(''true''=''true'',''false''=''false'')', now());
...
-- 6 - COD module
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Cash On Delivery Module', 'MODULE_PAYMENT_COD_STATUS', 'True', 'Do you want to accept Cash On Delevery payments?', '6', '1', 'choice(''true''=''true'',''false''=''false'')', now());
...
--6 - Shipping Flat
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Flat Shipping', 'MODULE_SHIPPING_FLAT_STATUS', 'True', 'Do you want to offer flat rate shipping?', '6', '0', 'choice(''true''=''true'',''false''=''false'')', now());
...
--6 - Order Totals
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Shipping', 'MODULE_ORDER_TOTAL_SHIPPING_STATUS', 'true', 'Do you want to display the order shipping cost?', '6', '1','choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Sub-Total', 'MODULE_ORDER_TOTAL_SUBTOTAL_STATUS', 'true', 'Do you want to display the order sub-total cost?', '6', '1','choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Tax', 'MODULE_ORDER_TOTAL_TAX_STATUS', 'true', 'Do you want to display the order tax value?', '6', '1','choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Total', 'MODULE_ORDER_TOTAL_TOTAL_STATUS', 'true', 'Do you want to display the total order value?', '6', '1','choice(''true''=''true'',''false''=''false'')', now());
...
-- 9
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Check stock level', 'STOCK_CHECK', 'true', 'Check to see if sufficent stock is available', '9', '1', 'choice(''true''=''true'',''false''=''false'')', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Subtract stock', 'STOCK_LIMITED', 'true', 'Subtract product in stock by product orders', '9', '2', 'choice(''true''=''true'',''false''=''false'')', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Allow Checkout', 'STOCK_ALLOW_CHECKOUT', 'true', 'Allow customer to checkout even if there is insufficient stock', '9', '3', 'choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Send E-Mails', 'SEND_EMAILS', 'true', 'Send out e-mails', '12', '1', 'choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) VALUES  ('SMTP Secure',          'SMTP_SECURE',          'false',                       'Whether or not the SMTP server needs user authentication', '12', '3', now(), 'choice(''true''=''true'',''false''=''false'')');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) VALUES  ('Debug Email Sessions', 'DEBUG_EMAIL_SESSIONS', 'false',                       'Debug email sessions',                                    '12', '7', now(), 'choice(''true''=''true'',''false''=''false'')');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Coupon Entry Field', 'DISPLAY_COUPON_ENTRY', 'true', 'During checkout the customer will be allowed to enter a coupon if set to true', '1', '22', 'choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Delete record on expiration', 'DD_DELETE_ON_EXPIRATION', 'true', 'When the download link expires, delete the database table record', 19, 3, 'choice(''true''=''true'',''false''=''false'')',now());
DELETE FROM configuration WHERE configuration_key = 'DD_DOWNLOAD_AS_ATTACHMENT';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Download as an attachment', 'DD_DOWNLOAD_AS_ATTACHMENT', 'true', 'Download the file as an attachment rather than viewing in the browser', 19, 4, 'choice(''true''=''true'',''false''=''false'')',now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Show Invisible Products', 'SHOW_INVISIBLE_PRODUCTS_IN_ADM', 'true', 'Show invisible products in the Admin App', 9, 4, 'choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Allow Free Shipping', 'MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING', 'false', 'Do you want to allow free shipping?', '6', '3','choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Security on API Calls', 'API_CALL_SECURITY', 'false', 'Do you want to enable security on API calls ?', '18', '5','choice(''true''=''true'',''false''=''false'')' , now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Add wildcard search before text', 'ADMIN_APP_ADD_WILDCARD_BEFORE', 'true', 'When set to true, a wildcard search character is added before the specified text', '21', '10', 'choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Run Initial Customer Search', 'CUST_PANEL_RUN_INITIAL_SEARCH', 'true', 'Set to true to always run the initial Customer Search', '21', '12', 'choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Clear button on Customer Panel removes results', 'CUST_PANEL_CLEAR_REMOVES_RESULTS', 'false', 'Set to true to clear both the search criteria AND the results when the clear button is clicked', '21', '13', 'choice(''true''=''true'',''false''=''false'')', now());



-- Add the ENABLE_ANALYTICS config variable
DELETE FROM configuration WHERE configuration_key = 'ENABLE_ANALYTICS';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Analytics', 'ENABLE_ANALYTICS', 'false', 'Enable analytics to have the analytics.code (in your Messages.properties file) inserted into the JSPs', '20', '3', 'choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Use Solr Search Server','USE_SOLR_SEARCH','false','Use Solr search server to search for products','24', '1', 'choice(''true''=''true'',''false''=''false'')', now());
DELETE FROM configuration WHERE configuration_key = 'SOLR_URL';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Base URL of Solr Search Server','SOLR_URL','http://localhost:8983/solr/konakart','Base URL of Solr Search Server','24', '2', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Store Credit Card Details', 'STORE_CC_DETAILS', 'false', 'Store credit card details', 9, 4, 'choice(''true''=''true'',''false''=''false'')', now());
...
DROP INDEX IF EXISTS idxcategories_store_id;
...
DROP INDEX IF EXISTS idxcategories_description_store_id;
...
DROP INDEX IF EXISTS idxconfiguration_store_id;
...
DROP INDEX IF EXISTS idxconfiguration_group_store_id;
...
DROP INDEX IF EXISTS idxcustomers_basket_attrs_store_id;
...
DROP INDEX IF EXISTS idxkk_category_to_tag_group_store_id;
...
DROP INDEX IF EXISTS idxkk_customer_group_store_id;
...
DROP INDEX IF EXISTS idxkk_digital_download_store_id;
...
DROP INDEX IF EXISTS idxkk_role_to_api_call_store_id;
...
DROP INDEX IF EXISTS idxkk_tag_group_to_tag_store_id;
...
DROP INDEX IF EXISTS idxkk_tag_to_product_store_id;
...
DROP INDEX IF EXISTS idxmanufacturers_info_store_id;
...
DROP INDEX IF EXISTS idxorders_products_attributes_store_id;
...
DROP INDEX IF EXISTS idxorders_products_download_store_id;
...
DROP INDEX IF EXISTS idxorders_returns_store_id;
...
DROP INDEX IF EXISTS idxorders_status_store_id;
...
DROP INDEX IF EXISTS idxorders_status_history_store_id;
...
DROP INDEX IF EXISTS idxproducts_attrs_download_store_id;
...
DROP INDEX IF EXISTS idxproducts_description_store_id;
...
DROP INDEX IF EXISTS idxproducts_notifications_store_id;
...
DROP INDEX IF EXISTS idxproducts_options_store_id;
...
DROP INDEX IF EXISTS idxproducts_options_values_store_id;
...
DROP INDEX IF EXISTS idxprod_opt_vals_to_prod_opt_store_id;
...
DROP INDEX IF EXISTS idxproducts_quantity_store_id;
...
DROP INDEX IF EXISTS idxproducts_to_categories_store_id;
...
DROP INDEX IF EXISTS idxproducts_to_products_store_id;
...
DROP INDEX IF EXISTS idxpromotion_to_coupon_store_id;
...
DROP INDEX IF EXISTS idxpromotion_to_cust_group_store_id;
...
DROP INDEX IF EXISTS idxpromotion_to_customer_store_id;
...
DROP INDEX IF EXISTS idxpromotion_to_manufacturer_store_id;
...
DROP INDEX IF EXISTS idxpromotion_to_product_store_id;
...
DROP INDEX IF EXISTS idxreturns_to_ord_prods_store_id;
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Gift Registry functionality', 'ENABLE_GIFT_REGISTRY', 'false', 'When set to true, gift registry functionality is enabled in the application', '1', '26', 'choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Customer WishList Tag functionality', 'ENABLE_CUSTOMER_WISHLIST_TAGS', 'false', 'When set to true, the application sets customer wish list tags', '5', '8', 'choice(''true''=''true'',''false''=''false'')', now());
...
DROP INDEX IF EXISTS idxproducts_attributes_products_id;
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Enable Reward Points', 'ENABLE_REWARD_POINTS', 'false', 'During checkout the customer will be allowed to enter reward points if set to true', '26', '1', 'choice(''true''=''true'',''false''=''false'')', now(), store_id FROM configuration WHERE configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Automatically Enable Product', 'STOCK_ENABLE_PRODUCT', 'false', 'Automatically enable a product if quantity is set to a positive number', '9', '4', 'choice(''true''=''true'',''false''=''false'')', now());
...
DROP INDEX IF EXISTS idxcustomers_customers_email_address;
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Warn of Duplicate SKUs', 'ADMIN_APP_WARN_OF_DUPLICATE_SKUS', 'false', 'Issue warning in Admin App of duplicate SKUs', '21', '32', 'choice(''true''=''true'',''false''=''false'')', now());
...
DROP INDEX IF EXISTS idxzones_zone_search;
...
DROP INDEX IF EXISTS idxproducts_manufacturers_id;
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Fetch Descriptions Separately', 'FETCH_PRODUCT_DESCRIPTIONS_SEPARATELY', 'false', 'Fetch Product Descriptions Separately', '9', '30', 'choice(''true''=''true'',''false''=''false'')', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Digital Downloads', 'MODULE_SHIPPING_DD_STATUS', 'True', 'Set it to true if you sell digital downloads', '6', '0', 'choice(''true''=''true'',''false''=''false'')', now());
...
DROP INDEX IF EXISTS idxproducts_product_uuid;
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Delete from index on commit','SOLR_DELETE_ON_COMMIT','true','On commit, delete from index products marked for deletion','24', '5', 'choice(''true''=''true'',''false''=''false'')', now(), '0');
...
DROP INDEX IF EXISTS idxcoupon_coupon_code;
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Storefront force login','APP_FORCE_LOOGIN','false','Set to true to force customers to login in order to be able to use the storefront application.','1', '38', 'choice(''true''=''true'',''false''=''false'')', now(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Cache Products','CACHE_PRODUCTS','true','Set to true to Cache Products in memory.','11', '15', 'choice(''true''=''true'',''false''=''false'')', now(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Cache Product Images','CACHE_PRODUCT_IMAGES','true','Set to true to Cache Product Image Names in memory.','11', '20', 'choice(''true''=''true'',''false''=''false'')', now(), '1');
...
DROP INDEX IF EXISTS idxkk_misc_price_product_id;
CREATE INDEX idxkk_misc_price_product_id ON kk_misc_price (product_id);
DROP INDEX IF EXISTS idxkk_misc_price_store_id;
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Enable "Other" Gender', 'ENABLE_OTHER_GENDER', 'false', 'Enable "Other" gender in addition to Male and Female', '5', '1', 'choice(''true''=''true'',''false''=''false'')', now(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Tax Id','ACCOUNT_TAX_ID','false','Display tax id in the customers account','5', '3', 'choice(''true''=''true'',''false''=''false'')', now(), '1');
...
DROP INDEX IF EXISTS idxkk_content_type_content_type_id;
CREATE INDEX idxkk_content_type_content_type_id ON kk_content_type (content_type_id);
...
DROP INDEX IF EXISTS idxkk_content_type_desc_content_type_id;
CREATE INDEX idxkk_content_type_desc_content_type_id ON kk_content_type_desc (content_type_id);
...
DROP INDEX IF EXISTS idxkk_content_content_id;
CREATE INDEX idxkk_content_content_id ON kk_content (content_id);
DROP INDEX IF EXISTS idxkk_content_search_key;
CREATE INDEX idxkk_content_search_key ON kk_content (search_key);
...
DROP INDEX IF EXISTS idxkk_content_desc_content_id;
CREATE INDEX idxkk_content_desc_content_id ON kk_content_desc (content_id);

-- Populate the Content tables
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (1, now());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (2, now());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (3, now());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (4, now());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (5, now());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (6, now());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (7, now());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (8, now());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (9, now());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (10, now());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (11, now());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (12, now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (1, 1, 'Top Banner', 'Top Banner - Top of store home page', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (1, 2, 'Top Banner', 'Top Banner - Top of store Startseite', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (1, 3, 'Top Banner', 'Top Banner - Inicio de tienda de la página principal', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (1, 4, 'Top Banner', 'Top Banner - Top of Home Page da loja', now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (2, 1, 'Sub Banner', 'Sub Banner - Secondary banner', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (2, 2, 'Sub Banner', 'Sub Banner - Sekundär banner', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (2, 3, 'Sub Banner', 'Sub Banner - banner Secundaria', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (2, 4, 'Sub Banner', 'Sub Banner - bandeira Secundário', now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (3, 1, 'Category Banner', 'Category Banner - Top of category pages', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (3, 2, 'Kategorie Banner', 'Kategorie Banner - Top of Kategorieseiten', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (3, 3, 'Categoria Banner', 'Categoría Banner - Inicio de las páginas de categorías', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (3, 4, 'Categoria Banner', 'Categoria Banner - Top de páginas da categoria', now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (4, 1, 'Category Sub Banner', 'Category Sub Banner - Secondary Category Banner', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (4, 2, 'Kategorie Unter Banner', 'Kategorie Unter Banner - Sekundäre Kategorie Banner', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (4, 3, 'Categoría Sub Banner', 'Categoría Sub Banner - Categoría Secundaria Banner', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (4, 4, 'Categoría Sub Banner', 'Categoria Sub Banner - Categoria Secundária Bandeira', now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (5, 1, 'About Us', 'About Us Text', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (5, 2, 'über uns', 'über uns', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (5, 3, 'sobre nosotros', 'sobre nosotros', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (5, 4, 'sobre nós', 'sobre nós', now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (6, 1, 'Shipping and Handling', 'Shipping and Handling Text', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (6, 2, 'Versand-und Bearbeitungs', 'Versand-und Bearbeitungs', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (6, 3, 'Envío y manipulación', 'Envío y manipulación', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (6, 4, 'Envio e manipulação', 'Envio e manipulação', now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (7, 1, 'Product Returns', 'Product Returns Text', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (7, 2, 'Produktrückgabe', 'Produktrückgabe', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (7, 3, 'Devolución de productos', 'Devolución de productos', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (7, 4, 'Devoluções de produtos', 'Devoluções de produtos', now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (8, 1, 'International Orders', 'International Orders Text', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (8, 2, 'International Orders', 'International Orders Text', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (8, 3, 'Pedidos internacionales', 'Pedidos internacionales', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (8, 4, 'Encomendas internacionais', 'Encomendas internacionais', now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (9, 1, 'Privacy Policy', 'Privacy Policy Text', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (9, 2, 'Datenschutz-Bestimmungen', 'Datenschutz-Bestimmungen', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (9, 3, 'Política de privacidad', 'política de privacidad', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (9, 4, 'Política De Privacidade', 'Política De Privacidade', now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (10, 1, 'Terms of use', 'Terms of use Text', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (10, 2, 'Nutzungsbedingungen', 'Nutzungsbedingungen', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (10, 3, 'Condiciones de uso', 'Condiciones de uso', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (10, 4, 'Termos de uso', 'Termos de uso', now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (11, 1, 'Help', 'Help Text', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (11, 2, 'Hilfe', 'Hilfe', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (11, 3, '¡Ayuda', '¡Ayuda', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (11, 4, 'Socorro', 'Socorro', now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (12, 1, 'Contact Us', 'Contact Us Text', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (12, 2, 'Kontaktdetails', 'Kontaktdetails', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (12, 3, 'Detalles de contacto', 'Detalles de contacto', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (12, 4, 'Detalhes de Contato', 'Detalhes de Contato', now());

-- Category Banners

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (1, 3, 'SelectProd.action?prodId={OBJ_ID}', 'Computer Peripherals', 31, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (1, 1, 'logitech.png', 'logitech-medium.png', 'logitech-small.png', 'Logitech Keyboard', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (1, 2, 'logitech.png', 'logitech-medium.png', 'logitech-small.png', 'Logitech Keyboard', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (1, 3, 'logitech.png', 'logitech-medium.png', 'logitech-small.png', 'Logitech Keyboard', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (1, 4, 'logitech.png', 'logitech-medium.png', 'logitech-small.png', 'Logitech Keyboard', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (2, 4, 'SelectProd.action?prodId={OBJ_ID}', 'Computer Peripherals', 27, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (2, 1, 'hp-photosmart.png', 'hp-photosmart-medium.png', 'hp-photosmart-small.png', 'HP Photosmart 5510', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (2, 2, 'hp-photosmart.png', 'hp-photosmart-medium.png', 'hp-photosmart-small.png', 'HP Photosmart 5510', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (2, 3, 'hp-photosmart.png', 'hp-photosmart-medium.png', 'hp-photosmart-small.png', 'HP Photosmart 5510', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (2, 4, 'hp-photosmart.png', 'hp-photosmart-medium.png', 'hp-photosmart-small.png', 'HP Photosmart 5510', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (3, 4, '', 'Computer Peripherals', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (3, 1, 'deals-of-the-week.png', 'deals-of-the-week-medium.png', 'deals-of-the-week-small.png', 'Deals of the Week', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (3, 2, 'deals-of-the-week.png', 'deals-of-the-week-medium.png', 'deals-of-the-week-small.png', 'Deals of the Week', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (3, 3, 'deals-of-the-week.png', 'deals-of-the-week-medium.png', 'deals-of-the-week-small.png', 'Deals of the Week', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (3, 4, 'deals-of-the-week.png', 'deals-of-the-week-medium.png', 'deals-of-the-week-small.png', 'Deals of the Week', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (4, 3, 'SelectProd.action?prodId={OBJ_ID}', 'Games', 63, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (4, 1, 'black-ops-2.png', 'black-ops-2-medium.png', 'black-ops-2-small.png', 'Black Ops 2', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (4, 2, 'black-ops-2.png', 'black-ops-2-medium.png', 'black-ops-2-small.png', 'Black Ops 2', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (4, 3, 'black-ops-2.png', 'black-ops-2-medium.png', 'black-ops-2-small.png', 'Black Ops 2', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (4, 4, 'black-ops-2.png', 'black-ops-2-medium.png', 'black-ops-2-small.png', 'Black Ops 2', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (5, 4, 'SelectProd.action?prodId={OBJ_ID}', 'Games', 21, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (5, 1, 'swat-3.png', 'swat-3-medium.png', 'swat-3-small.png', 'Swat-3', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (5, 2, 'swat-3.png', 'swat-3-medium.png', 'swat-3-small.png', 'Swat-3', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (5, 3, 'swat-3.png', 'swat-3-medium.png', 'swat-3-small.png', 'Swat-3', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (5, 4, 'swat-3.png', 'swat-3-medium.png', 'swat-3-small.png', 'Swat-3', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (6, 4, '', 'Games', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (6, 1, 'winter-deals.png', 'winter-deals-medium.png', 'winter-deals-small.png', 'Winter Deals', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (6, 2, 'winter-deals.png', 'winter-deals-medium.png', 'winter-deals-small.png', 'Winter Deals', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (6, 3, 'winter-deals.png', 'winter-deals-medium.png', 'winter-deals-small.png', 'Winter Deals', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (6, 4, 'winter-deals.png', 'winter-deals-medium.png', 'winter-deals-small.png', 'Winter Deals', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (7, 3, 'SelectProd.action?prodId={OBJ_ID}', 'DVD Movies', 20, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (7, 1, 'dark-knight.png', 'dark-knight-medium.png', 'dark-knight-small.png', 'Dark Night', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (7, 2, 'dark-knight.png', 'dark-knight-medium.png', 'dark-knight-small.png', 'Dark Night', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (7, 3, 'dark-knight.png', 'dark-knight-medium.png', 'dark-knight-small.png', 'Dark Night', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (7, 4, 'dark-knight.png', 'dark-knight-medium.png', 'dark-knight-small.png', 'Dark Night', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (8, 4, 'SelectProd.action?prodId={OBJ_ID}', 'DVD Movies', 11, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (8, 1, 'harry-potter.png', 'harry-potter-medium.png', 'harry-potter-small.png', 'Harry Potter', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (8, 2, 'harry-potter.png', 'harry-potter-medium.png', 'harry-potter-small.png', 'Harry Potter', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (8, 3, 'harry-potter.png', 'harry-potter-medium.png', 'harry-potter-small.png', 'Harry Potter', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (8, 4, 'harry-potter.png', 'harry-potter-medium.png', 'harry-potter-small.png', 'Harry Potter', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (9, 4, '', 'DVD Movies', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (9, 1, 'movie-deals.png', 'movie-deals-medium.png', 'movie-deals-small.png', 'Movie Deals', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (9, 2, 'movie-deals.png', 'movie-deals-medium.png', 'movie-deals-small.png', 'Movie Deals', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (9, 3, 'movie-deals.png', 'movie-deals-medium.png', 'movie-deals-small.png', 'Movie Deals', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (9, 4, 'movie-deals.png', 'movie-deals-medium.png', 'movie-deals-small.png', 'Movie Deals', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (10, 3, 'SelectProd.action?prodId={OBJ_ID}', 'Electronics', 34, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (10, 1, 'kindle-fire-hd.jpg', 'kindle-fire-hd-medium.jpg', 'kindle-fire-hd-small.jpg', 'Kindle Fire', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (10, 2, 'kindle-fire-hd.jpg', 'kindle-fire-hd-medium.jpg', 'kindle-fire-hd-small.jpg', 'Kindle Fire', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (10, 3, 'kindle-fire-hd.jpg', 'kindle-fire-hd-medium.jpg', 'kindle-fire-hd-small.jpg', 'Kindle Fire', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (10, 4, 'kindle-fire-hd.jpg', 'kindle-fire-hd-medium.jpg', 'kindle-fire-hd-small.jpg', 'Kindle Fire', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (11, 4, '', 'Electronics', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (11, 1, 'xbox.png', 'xbox-medium.png', 'xbox-small.png', 'Xbox', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (11, 2, 'xbox.png', 'xbox-medium.png', 'xbox-small.png', 'Xbox', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (11, 3, 'xbox.png', 'xbox-medium.png', 'xbox-small.png', 'Xbox', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (11, 4, 'xbox.png', 'xbox-medium.png', 'xbox-small.png', 'Xbox', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (12, 4, '', 'Electronics', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (12, 1, 'electronics-sale.png', 'electronics-sale-medium.png', 'electronics-sale-small.png', 'Electronics Sale', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (12, 2, 'electronics-sale.png', 'electronics-sale-medium.png', 'electronics-sale-small.png', 'Electronics Sale', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (12, 3, 'electronics-sale.png', 'electronics-sale-medium.png', 'electronics-sale-small.png', 'Electronics Sale', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (12, 4, 'electronics-sale.png', 'electronics-sale-medium.png', 'electronics-sale-small.png', 'Electronics Sale', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (13, 3, 'SelectProd.action?prodId={OBJ_ID}', 'Home & Garden', 33, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (13, 1, 'delonghi.png', 'delonghi-medium.png', 'delonghi-small.png', 'DeLonghi Coffee Maker', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (13, 2, 'delonghi.png', 'delonghi-medium.png', 'delonghi-small.png', 'DeLonghi Coffee Maker', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (13, 3, 'delonghi.png', 'delonghi-medium.png', 'delonghi-small.png', 'DeLonghi Coffee Maker', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (13, 4, 'delonghi.png', 'delonghi-medium.png', 'delonghi-small.png', 'DeLonghi Coffee Maker', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (14, 4, 'SelectProd.action?prodId={OBJ_ID}', 'Home & Garden', 39, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (14, 1, 'rotak-40.png', 'rotak-40-medium.png', 'rotak-40-small.png', 'Rotak 40', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (14, 2, 'rotak-40.png', 'rotak-40-medium.png', 'rotak-40-small.png', 'Rotak 40', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (14, 3, 'rotak-40.png', 'rotak-40-medium.png', 'rotak-40-small.png', 'Rotak 40', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (14, 4, 'rotak-40.png', 'rotak-40-medium.png', 'rotak-40-small.png', 'Rotak 40', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (15, 4, '', 'Home & Garden', 39, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (15, 1, 'gifts-for-the-home.png', 'gifts-for-the-home-medium.png', 'gifts-for-the-home-small.png', 'Gifts for the home', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (15, 2, 'gifts-for-the-home.png', 'gifts-for-the-home-medium.png', 'gifts-for-the-home-small.png', 'Gifts for the home', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (15, 3, 'gifts-for-the-home.png', 'gifts-for-the-home-medium.png', 'gifts-for-the-home-small.png', 'Gifts for the home', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (15, 4, 'gifts-for-the-home.png', 'gifts-for-the-home-medium.png', 'gifts-for-the-home-small.png', 'Gifts for the home', now());

-- Top Banners on Home Page

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (16, 1, 'SelectProd.action?prodId={OBJ_ID}', 34, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (16, 1, 'home_kindle-fire-hd.jpg', 'home_kindle-fire-hd-medium.jpg', 'home_kindle-fire-hd-small.jpg', 'Kindle Fire', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (16, 2, 'home_kindle-fire-hd.jpg', 'home_kindle-fire-hd-medium.jpg', 'home_kindle-fire-hd-small.jpg', 'Kindle Fire', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (16, 3, 'home_kindle-fire-hd.jpg', 'home_kindle-fire-hd-medium.jpg', 'home_kindle-fire-hd-small.jpg', 'Kindle Fire', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (16, 4, 'home_kindle-fire-hd.jpg', 'home_kindle-fire-hd-medium.jpg', 'home_kindle-fire-hd-small.jpg', 'Kindle Fire', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (17, 1, 'SelectProd.action?prodId={OBJ_ID}', 33, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (17, 1, 'home_delonghi.png', 'home_delonghi-medium.png', 'home_delonghi-small.png', 'DeLonghi Coffee Maker', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (17, 2, 'home_delonghi.png', 'home_delonghi-medium.png', 'home_delonghi-small.png', 'DeLonghi Coffee Maker', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (17, 3, 'home_delonghi.png', 'home_delonghi-medium.png', 'home_delonghi-small.png', 'DeLonghi Coffee Maker', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (17, 4, 'home_delonghi.png', 'home_delonghi-medium.png', 'home_delonghi-small.png', 'DeLonghi Coffee Maker', now());

-- Sub-Banners on Home Page

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (18, 2, 'ShowSpecials.action', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (18, 1, 'home_electronics-sale.jpg', 'Electronics Sale', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (18, 2, 'home_electronics-sale.jpg', 'Electronics Sale', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (18, 3, 'home_electronics-sale.jpg', 'Electronics Sale', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (18, 4, 'home_electronics-sale.jpg', 'Electronics Sale', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (19, 2, 'SelectCat.action?catId={OBJ_ID}', 23, 2, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (19, 1, 'home_electronics-sale-2.jpg', 'Electronics Sale', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (19, 2, 'home_electronics-sale-2.jpg', 'Electronics Sale', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (19, 3, 'home_electronics-sale-2.jpg', 'Electronics Sale', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (19, 4, 'home_electronics-sale-2.jpg', 'Electronics Sale', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (20, 2, 'SelectCat.action?catId={OBJ_ID}', 24, 2, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (20, 1, 'home_gifts-for-the-home.jpg', 'Gifts for the home', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (20, 2, 'home_gifts-for-the-home.jpg', 'Gifts for the home', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (20, 3, 'home_gifts-for-the-home.jpg', 'Gifts for the home', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (20, 4, 'home_gifts-for-the-home.jpg', 'Gifts for the home', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (21, 2, 'SelectProd.action?prodId={OBJ_ID}', 32, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (21, 1, 'home_windows-8.jpg', 'Windows-8', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (21, 2, 'home_windows-8.jpg', 'Windows-8', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (21, 3, 'home_windows-8.jpg', 'Windows-8', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (21, 4, 'home_windows-8.jpg', 'Windows-8', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (22, 2, 'SelectProd.action?prodId={OBJ_ID}', 35, 1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (22, 1, 'home_iphone-5.jpg', 'iPhone 5', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (22, 2, 'home_iphone-5.jpg', 'iPhone 5', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (22, 3, 'home_iphone-5.jpg', 'iPhone 5', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (22, 4, 'home_iphone-5.jpg', 'iPhone 5', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (23, 5, '', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (23, 1, 'Add your About Us information here.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (23, 2, 'Fügen Sie Ihre Über uns Informationen hier', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (23, 3, 'Añade tu Quiénes somos información aquí', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (23, 4, 'Adicione a sua Quem somos informações aqui', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (24, 6, '', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (24, 1, 'Add your Shipping and Handling information here.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (24, 2, 'Fügen Sie Ihre Versandinformationen hier', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (24, 3, 'Agregue su envío y manipulación de información aquí', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (24, 4, 'Adicione sua informação de envio aqui', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (25, 7, '', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (25, 1, 'Add your Returns information here.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (25, 2, 'Fügen Sie Ihre Versandkosten Informationen finden Sie hier', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (25, 3, 'Añade tu información Devoluciones aquí', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (25, 4, 'Adicione sua informação Returns aqui', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (26, 8, '', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (26, 1, 'Add your International Orders information here.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (26, 2, 'Fügen Sie hier Ihre Informationen Internationale Bestellungen.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (26, 3, 'Añade tu información Internacional Órdenes aquí.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (26, 4, 'Adicione sua informação Internacional Ordens aqui.', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (27, 9, '', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (27, 1, 'Add your Privacy Policy here.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (27, 2, 'Fügen Sie Ihren Datenschutz hier.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (27, 3, 'Agregue su política de privacidad aquí.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (27, 4, 'Adicione a sua Política de Privacidade aqui.', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (28, 10, '', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (28, 1, 'Add your Terms of Use here.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (28, 2, 'Fügen Sie Ihr Nutzungsbedingungen hier', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (28, 3, 'Añada sus Términos de Uso aquí', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (28, 4, 'Adicione seus Termos de Uso aqui', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (29, 11, '', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (29, 1, 'Add your Help information here.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (29, 2, 'Fügen Sie hier Ihre Informationen Hilfe.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (29, 3, 'Añade tu información de ayuda aquí.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (29, 4, 'Adicione sua informação ajuda aqui.', now());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (30, 12, '', 0, 0, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (30, 1, 'Add your Contact information here.', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (30, 2, 'Fügen Sie Ihre Kontaktinformationen hier', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (30, 3, 'Añadir su información de contacto aquí', now());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (30, 4, 'Adicione sua informação de contato aqui', now());

-- New API calls for Content
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getContents', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getContent', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertContent', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deleteContent', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'updateContent', '', now());

INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getContentTypes', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getContentType', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertContentType', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deleteContentType', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'updateContentType', '', now());

-- New Admin App Panels for Content

INSERT INTO kk_panel (code, description, date_added) VALUES ('kk_panel_contentTypes','Content Types', now());

-- Add Content Type Panel access to all roles that can access the 'kk_panel_storeConfiguration' panel
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, p2.panel_id, 1, 1, 1, now(), store_id FROM kk_role_to_panel rtp, kk_panel p, kk_panel p2 where rtp.panel_id=p.panel_id and p.code='kk_panel_storeConfiguration' and p2.code='kk_panel_contentTypes';

INSERT INTO kk_panel (code, description, date_added) VALUES ('kk_panel_content','Content', now());

-- Add Content Panel access to all roles that can access the 'kk_panel_storeConfiguration' panel
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, p2.panel_id, 1, 1, 1, now(), store_id FROM kk_role_to_panel rtp, kk_panel p, kk_panel p2 where rtp.panel_id=p.panel_id and p.code='kk_panel_storeConfiguration' and p2.code='kk_panel_content';

INSERT INTO kk_panel (code, description, date_added) VALUES ('kk_panel_editContent','Edit Content', now());

-- Add Content Panel access to all roles that can access the 'kk_panel_storeConfiguration' panel
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, p2.panel_id, 1, 1, 1, now(), store_id FROM kk_role_to_panel rtp, kk_panel p, kk_panel p2 where rtp.panel_id=p.panel_id and p.code='kk_panel_storeConfiguration' and p2.code='kk_panel_editContent';

-- Add a search key to categories
ALTER TABLE categories ADD COLUMN search_key varchar(128);
UPDATE categories C SET search_key = CD.categories_name FROM categories_description CD WHERE C.categories_id = CD.categories_id AND CD.language_id IN (SELECT languages_id FROM languages L, configuration CON WHERE code=configuration_value AND configuration_key='DEFAULT_LANGUAGE');

DELETE FROM configuration WHERE configuration_key = 'ENABLE_KONAKART_CONTENT';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api, store_id) SELECT 'Enable KonaKart Content', 'ENABLE_KONAKART_CONTENT', 'false', 'When set to true, KonaKart Content is enabled', '1', '10', 'choice(''true''=''true'',''false''=''false'')', now(), 1, store_id FROM configuration WHERE configuration_key = 'STORE_COUNTRY';

-- Add iso_numeric and custom1 columns to countries
ALTER TABLE countries ADD COLUMN iso_numeric VARCHAR(10);
ALTER TABLE countries ADD COLUMN custom1 VARCHAR(10);
...
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (13, now());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (13, 1, 'Logo', 'Logo Image', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (13, 2, 'Logo', 'Logo Image', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (13, 3, 'Logo', 'Imagen del logotipo', now());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (13, 4, 'Logotipo', 'Imagem do logotipo', now());

-- Logo Image
INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (31, 13, 'Welcome.action', -1, -1, 1, 2, now(), now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (31, 1, 'logo.png', '', '', 'KonaKart Logo', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (31, 2, 'logo.png', '', '', 'KonaKart Logo', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (31, 3, 'logo.png', '', '', 'KonaKart Logo', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (31, 4, 'logo.png', '', '', 'KonaKart Logo', now());

-- Configuration variable to enable/disable Content Caching
DELETE FROM configuration WHERE configuration_key = 'CACHE_CONTENT';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Cache Content','CACHE_CONTENT','true','Set to true to Cache KonaKart Content in memory.','11', '28', 'choice(''true''=''true'',''false''=''false'')', now(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Add suggested search for catalog','SOLR_ADD_TERM_FOR_CATALOG','false','Adds a suggested search list for each catalog id since the catalog may contain only a subset of products','24', '30', 'choice(''true''=''true'',''false''=''false'')', now(), '1');

DELETE FROM configuration WHERE configuration_key = 'SOLR_ADD_SPELLING_FOR_CATALOG';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Add spelling suggestions for catalog','SOLR_ADD_SPELLING_FOR_CATALOG','false','Adds spelling suggestions for each catalog id since the catalog may contain only a subset of products','24', '32', 'choice(''true''=''true'',''false''=''false'')', now(), '1');

DELETE FROM configuration WHERE configuration_key = 'SOLR_CATALOG_USED_FOR_PRICE';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Catalogs used for product prices','SOLR_CATALOG_USED_FOR_PRICE','false','Set to true if catalogs are used to determine product prices','24', '34', 'choice(''true''=''true'',''false''=''false'')', now(), '0');

DELETE FROM configuration WHERE configuration_key = 'SOLR_CATALOG_USED_FOR_QTY';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Catalogs used for product quantities','SOLR_CATALOG_USED_FOR_QTY','false','Set to true if catalogs are used to determine product quantities','24', '36', 'choice(''true''=''true'',''false''=''false'')', now(), '0');
...
DROP INDEX IF EXISTS idxkk_filter_user_id;
...
INSERT INTO address_book (address_book_id, customers_id, entry_gender, entry_company, entry_firstname, entry_lastname, entry_street_address, entry_suburb, entry_postcode, entry_city, entry_state, entry_country_id, entry_zone_id) VALUES (DEFAULT,-1, 'm', 'KonaKart Ltd.', 'Order', 'Followup', '4 Way Street', '', 'PostCode4', 'NeverNever', '', 223, 12);
...
INSERT INTO customers_info SELECT customers_id , now(), 0, now(), now(), 0, 'store1' FROM customers WHERE customers_email_address = 'order.followup@konakart.com' AND customers_telephone='019084';
...
INSERT INTO kk_customers_to_role (role_id, customers_id, date_added) SELECT 3, customers_id, now() FROM customers WHERE customers_email_address = 'order.followup@konakart.com' AND customers_telephone='019084';
INSERT INTO kk_customers_to_role (role_id, customers_id, date_added) SELECT 4, customers_id, now() FROM customers WHERE customers_email_address = 'order.followup@konakart.com' AND customers_telephone='019084';
...
INSERT INTO kk_filter (user_id, filter_table, filter_column, filter_constraint, date_added, date_updated) SELECT customers_id, 'orders', 'orders_status', 'in (2,4)', now(), now() FROM customers WHERE customers_email_address = 'order.followup@konakart.com' AND customers_telephone='019084';
...
UPDATE configuration SET configuration_value = 'C:/KonaKart/database/PostgreSQL/konakart_new_store.sql' WHERE configuration_key = 'KK_NEW_STORE_SQL_FILENAME';
UPDATE configuration SET configuration_value = 'C:/KonaKart/database/PostgreSQL/konakart_user_new_store.sql' WHERE configuration_key = 'USER_NEW_STORE_SQL_FILENAME';
...
INSERT INTO prod_opt_vals_to_prod_opt (prod_opt_vals_to_prod_opt_id, products_options_id, products_options_values_id) VALUES (DEFAULT, 1, 13);
INSERT INTO prod_opt_vals_to_prod_opt (prod_opt_vals_to_prod_opt_id, products_options_id, products_options_values_id) VALUES (DEFAULT, 1, 14);
INSERT INTO prod_opt_vals_to_prod_opt (prod_opt_vals_to_prod_opt_id, products_options_id, products_options_values_id) VALUES (DEFAULT, 1, 15);

UPDATE products_options SET code = 'COL' WHERE products_options_id = '1';

-- Add color attributes to Brabantia Bin product
INSERT INTO products_attributes (products_attributes_id, products_id, options_id, options_values_id, options_values_price, price_prefix, sort_order) VALUES (DEFAULT,44,1,13,0.00,'+',1);
INSERT INTO products_attributes (products_attributes_id, products_id, options_id, options_values_id, options_values_price, price_prefix, sort_order) VALUES (DEFAULT,44,1,14,0.00,'+',0);
INSERT INTO products_attributes (products_attributes_id, products_id, options_id, options_values_id, options_values_price, price_prefix, sort_order) VALUES (DEFAULT,44,1,15,0.00,'+',2);
...
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (DEFAULT,'Åland Islands','AX','ALA',1, '248');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (DEFAULT,'Guernsey','GG','GGY',1, '831');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (DEFAULT,'Montenegro','ME','MNE',1, '499');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (DEFAULT,'Palestine','PS','PSE',1, '275');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (DEFAULT,'Saint Barthélemy','BL','BLM',1, '652');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (DEFAULT,'Saint Helena, Ascension and Tristan da Cunha','SH','SHN',1, '654');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (DEFAULT,'Saint Martin (French part)','MF','MAF',1, '663');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (DEFAULT,'Saint Pierre and Miquelon','PM','SPM',1, '666');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (DEFAULT,'Sint Maarten (Dutch part)','SX','SXM',1, '534');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (DEFAULT,'South Sudan','SS','SSD',1, '728');
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES (DEFAULT,'Timor-Leste','TL','TLS',1, '626');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Enable stock reservation','STOCK_RESERVATION_ENABLE','false','Set to true if you want to reserve stock during checkout','9', '40', 'choice(''true''=''true'',''false''=''false'')', now(), '1');

-- Defines global stock reservation time
DELETE FROM configuration WHERE configuration_key = 'STOCK_RESERVATION_TIME_SECS';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Stock Reservation time in secs','STOCK_RESERVATION_TIME_SECS','0','Number of seconds stock will be reserved for','9', '45', 'integer(0,null)', now(), '1');
...
-- New API call
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'addRelatedProductsWithOptions', '', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Allow Checkout When Stock Not Available','STORE_FRONT_STOCK_ALLOW_CHECKOUT','true','When true, the storefront allows checkout even when stock is not available','9', '2', 'choice(''true''=''true'',''false''=''false'')', now(), '1');
...
ALTER TABLE currencies ALTER COLUMN value TYPE DECIMAL(15,6);
...
-- New API calls
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'addChildrenToCustomer', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getCustomerForEmailWithOptions', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getCustomerForIdWithOptions', '', now());

--B2B Customer tag examples
DELETE FROM kk_customer_tag WHERE name ='B2B_CAN_CHANGE_ADDRESS';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_CAN_CHANGE_ADDRESS', 'Customer can modify / add the destination addresses of an order', 'true|false', 5, 1, now());
DELETE FROM kk_customer_tag WHERE name ='B2B_CAN_APPROVE_ORDERS';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_CAN_APPROVE_ORDERS', 'Customer can approve orders of child customers', 'true|false', 5, 1, now());
DELETE FROM kk_customer_tag WHERE name ='B2B_VIEW_PARENT_ORDERS';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_VIEW_PARENT_ORDERS', 'Customer can view orders of parent customer', 'true|false', 5, 1, now());
DELETE FROM kk_customer_tag WHERE name ='B2B_VIEW_CHILD_ORDERS';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_VIEW_CHILD_ORDERS', 'Customer can view orders of child customers', 'true|false', 5, 1, now());
DELETE FROM kk_customer_tag WHERE name ='B2B_VIEW_SIBLING_ORDERS';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_VIEW_SIBLING_ORDERS', 'Customer can view orders of sibling customers', 'true|false', 5, 1, now());
DELETE FROM kk_customer_tag WHERE name ='B2B_ORDERS_NEED_APPROVAL';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_ORDERS_NEED_APPROVAL', 'Order needs to be approved by a parent customer', 'true|false', 5, 1, now());
DELETE FROM kk_customer_tag WHERE name ='B2B_ORDER_LIMIT';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_ORDER_LIMIT', 'Maximum order value that can be submitted by this customer', '', 3, 1, now());
DELETE FROM kk_customer_tag WHERE name ='B2B_CATALOG_KEY';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_CATALOG_KEY', 'Catalog Key used for this customer', '', 0, 1, now());
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 11,(SELECT languages_id FROM languages WHERE code = 'en'),'Waiting for Approval');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 11,(SELECT languages_id FROM languages WHERE code = 'de'),'Warten auf die Bestätigung');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 11,(SELECT languages_id FROM languages WHERE code = 'es'),'A la espera de la aprobación');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 11,(SELECT languages_id FROM languages WHERE code = 'pt'),'Esperando aprovação');

-- New order state - Approved
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 12,(SELECT languages_id FROM languages WHERE code = 'en'),'Approved');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 12,(SELECT languages_id FROM languages WHERE code = 'de'),'Genehmigt');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 12,(SELECT languages_id FROM languages WHERE code = 'es'),'Aprobado');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 12,(SELECT languages_id FROM languages WHERE code = 'pt'),'Aprovado');

-- New order state - Approval Declined
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 13,(SELECT languages_id FROM languages WHERE code = 'en'),'Approval Declined');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 13,(SELECT languages_id FROM languages WHERE code = 'de'),'Approval Abgelehnt');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 13,(SELECT languages_id FROM languages WHERE code = 'es'),'Se rechaza la aprobación');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 13,(SELECT languages_id FROM languages WHERE code = 'pt'),'Aprovação Recusado');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Name format template', 'NAME_FORMAT_TEMPLATE', '$firstname $lastname', 'The default template used for formatting a customer name', '5', '20', now(), '1');

------------------------------------------------------------------
-- ERP XML Interface

INSERT INTO configuration_group VALUES (DEFAULT, 'User Defined', 'User Defined Configuration', 31, 1, null);
INSERT INTO configuration_group VALUES (DEFAULT, 'ERP Integration', 'ERP Integration Configuration', 32, 1, null);
...
-- Password expiry
ALTER TABLE customers ADD COLUMN password_change INTEGER DEFAULT '0' NOT NULL;
ALTER TABLE customers ADD COLUMN password_expiry TIMESTAMP;
...
DROP INDEX IF EXISTS idxspecials_products_id;
CREATE INDEX idxspecials_products_id ON specials (products_id);
DROP INDEX IF EXISTS idxconfiguration_configuration_key;
CREATE INDEX idxconfiguration_configuration_key ON configuration (configuration_key);
DROP INDEX IF EXISTS idxkk_customers_to_tag_customers_id;
CREATE INDEX idxkk_customers_to_tag_customers_id ON kk_customers_to_tag (customers_id);
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 14,(SELECT languages_id FROM languages WHERE code = 'en'),'Archived');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 14,(SELECT languages_id FROM languages WHERE code = 'de'),'Archivierte');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 14,(SELECT languages_id FROM languages WHERE code = 'es'),'Archivado');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 14,(SELECT languages_id FROM languages WHERE code = 'pt'),'Arquivado');
...
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('HISTORY', '8.5.0.0 I', now());
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('VERSION', '8.5.0.0 PostgreSQL', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Update product viewed count','UPDATE_PRODUCT_VIEWED_COUNT','false','When true, the product viewed count is incremented every time a product is viewed',1, 55, 'choice(''true''=''true'',''false''=''false'')', now(), '1');
...
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('PROMOTION_TESTER', 'Promotion Tester', 'true|false', 5, 1, now());

--Promotion tester expression
DELETE FROM kk_expression WHERE name ='PromotionTester';
INSERT INTO kk_expression (name, description, num_variables, date_added) VALUES ('PromotionTester', 'Determines whether user is a promotion tester',1,now());
...
INSERT INTO kk_expression_variable (kk_customer_tag_id, kk_expression_id, tag_type, tag_value, date_added) VALUES ((select kk_customer_tag_id from kk_customer_tag where name ='PROMOTION_TESTER'),(select kk_expression_id from kk_expression where name ='PromotionTester'),5,'true',now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Promotion Tester Expression', 'PROMOTION_TESTER_EXPRESSION', 'PromotionTester', 'The expression used for determining promotion testers', '5', '25', now(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('TZ DB Time Zone', 'TZ_DB_TIME_ZONE', '', 'The tz database time zone for the store. e.g. US/Pacific', '1', '7', now(), '1');
...
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_AGGREGATE_ORDER_LIMIT', 'Maximum total order value that can be submitted in a period of time', '', 3, 1, now());
DELETE FROM kk_customer_tag WHERE name ='B2B_AGGREGATE_ORDER_TOTAL';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_AGGREGATE_ORDER_TOTAL', 'The current order value total for a period of time', '', 3, 1, now());

-- Admin Caches
DELETE FROM configuration WHERE configuration_key = 'ADMIN_CONFIG_CACHE_CHECK_SECS';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Admin caches refresh check interval', 'ADMIN_CONFIG_CACHE_CHECK_SECS', '30', 'Interval in seconds for checking to see whether to refresh the KonaKartAdmin caches', '11', '10', now(), '1');

DELETE FROM configuration WHERE configuration_key = 'ADMIN_CONFIG_CACHE_CHECK_FLAG';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Admin caches refresh flag','ADMIN_CONFIG_CACHE_CHECK_FLAG','false','Boolean to determine whether to refresh the admin config caches','100','1', now(), '1');
