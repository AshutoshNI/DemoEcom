...
-- 
-- -----------------------------------------------------------
-- KonaKart v8.5.0.0 demo database script for MS Sql Server
-- Created: Wed Jan 18 04:55:13 GMT 2017
-- -----------------------------------------------------------
-- 
...
CREATE TABLE address_book (
  ...
  entry_company NVARCHAR(32),
  entry_firstname NVARCHAR(32) NOT NULL,
  entry_lastname NVARCHAR(32) NOT NULL,
  entry_street_address NVARCHAR(64) NOT NULL,
  entry_suburb NVARCHAR(32),
  entry_postcode NVARCHAR(10) NOT NULL,
  entry_city NVARCHAR(32) NOT NULL,
  entry_state NVARCHAR(32),
...
CREATE TABLE configuration (
  ...
  configuration_title NVARCHAR(64) NOT NULL,
  configuration_key varchar(64) NOT NULL,
  configuration_value NVARCHAR(255) NULL,
  configuration_description NVARCHAR(255) NOT NULL,
...
CREATE TABLE configuration_group (
  ...
  sort_order int NULL,
  visible smallint DEFAULT 1 NULL,
...
CREATE TABLE countries (
  ...
  countries_name NVARCHAR(64) NOT NULL,
...
CREATE TABLE currencies (
  ...
  symbol_left NVARCHAR(12),
  symbol_right NVARCHAR(12),
...
CREATE TABLE customers (
  ...
  customers_firstname NVARCHAR(32) NOT NULL,
  customers_lastname NVARCHAR(32) NOT NULL,
  customers_dob datetime NOT NULL,
  customers_email_address NVARCHAR(96) NOT NULL,
  customers_default_address_id int NOT NULL,
  customers_telephone NVARCHAR(32) NOT NULL,
  customers_fax NVARCHAR(32),
  customers_password NVARCHAR(40) NOT NULL,
...
CREATE TABLE customers_basket (
  ...
  customers_id int NOT NULL,
  products_id NVARCHAR(255) NOT NULL,
...
CREATE TABLE customers_info (
  ...
  global_product_notifications smallint DEFAULT 0,
...
CREATE TABLE manufacturers (
  ...
  manufacturers_name NVARCHAR(32) NOT NULL,
  manufacturers_image NVARCHAR(64),
...
CREATE TABLE manufacturers_info (
  ...
  manufacturers_url NVARCHAR(255) NOT NULL,
...
CREATE TABLE orders (
  ...
  customers_id int NOT NULL,
  customers_name NVARCHAR(64) NOT NULL,
  customers_company NVARCHAR(32),
  customers_street_address NVARCHAR(64) NOT NULL,
  customers_suburb NVARCHAR(32),
  customers_city NVARCHAR(32) NOT NULL,
  customers_postcode NVARCHAR(10) NOT NULL,
  customers_state NVARCHAR(32),
  customers_country NVARCHAR(32) NOT NULL,
  customers_telephone NVARCHAR(32) NOT NULL,
  customers_email_address NVARCHAR(96) NOT NULL,
  customers_address_format_id int NOT NULL,
  delivery_name NVARCHAR(64) NOT NULL,
  delivery_company NVARCHAR(32),
  delivery_street_address NVARCHAR(64) NOT NULL,
  delivery_suburb NVARCHAR(32),
  delivery_city NVARCHAR(32) NOT NULL,
  delivery_postcode NVARCHAR(10) NOT NULL,
  delivery_state NVARCHAR(32),
  delivery_country NVARCHAR(32) NOT NULL,
  delivery_address_format_id int NOT NULL,
  billing_name NVARCHAR(64) NOT NULL,
  billing_company NVARCHAR(32),
  billing_street_address NVARCHAR(64) NOT NULL,
  billing_suburb NVARCHAR(32),
  billing_city NVARCHAR(32) NOT NULL,
  billing_postcode NVARCHAR(10) NOT NULL,
  billing_state NVARCHAR(32),
  billing_country NVARCHAR(32) NOT NULL,
  billing_address_format_id int NOT NULL,
  payment_method NVARCHAR(32) NOT NULL,
  cc_type NVARCHAR(20),
  cc_owner NVARCHAR(64),
  cc_number NVARCHAR(32),
  cc_expires NVARCHAR(4),
  last_modified datetime,
...
CREATE TABLE orders_status_history (
  ...
  date_added datetime NOT NULL,
  customer_notified smallint DEFAULT 0,
...
CREATE TABLE orders_products_attributes (
  ...
  products_options_values NVARCHAR(32) NOT NULL,
...
CREATE TABLE orders_products_download (
  ...
  orders_products_filename NVARCHAR(255) NOT NULL,
...
CREATE TABLE products_attrs_download (
  ...
  products_attributes_filename NVARCHAR(255) NOT NULL,
...
CREATE TABLE tax_class (
  ...
  tax_class_title NVARCHAR(32) NOT NULL,
  tax_class_description NVARCHAR(255) NOT NULL,
  last_modified datetime NULL,
  date_added datetime NOT NULL,
...
CREATE TABLE tax_rates (
  ...
  tax_description NVARCHAR(255) NOT NULL,
  last_modified datetime NULL,
  date_added datetime NOT NULL,
...
CREATE TABLE geo_zones (
  ...
  geo_zone_name NVARCHAR(32) NOT NULL,
  geo_zone_description NVARCHAR(255) NOT NULL,
  last_modified datetime NULL,
  date_added datetime NOT NULL,
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Prices with Tax', 'DISPLAY_PRICE_WITH_TAX', 'false', 'Display prices with tax included (true) or add the tax at the end (false)', '1', '21', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
-- 5
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Gender', 'ACCOUNT_GENDER', 'true', 'Display gender in the customers account', '5', '1', 'choice(''true''=''true'',''false''=''false'')', getdate());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Date of Birth', 'ACCOUNT_DOB', 'true', 'Display date of birth in the customers account', '5', '2', 'choice(''true''=''true'',''false''=''false'')', getdate());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Company', 'ACCOUNT_COMPANY', 'true', 'Display company in the customers account', '5', '3', 'choice(''true''=''true'',''false''=''false'')', getdate());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Suburb', 'ACCOUNT_SUBURB', 'true', 'Display suburb in the customers account', '5', '4', 'choice(''true''=''true'',''false''=''false'')', getdate());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('State', 'ACCOUNT_STATE', 'true', 'Display state in the customers account', '5', '5', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
-- 6 - COD module
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Cash On Delivery Module', 'MODULE_PAYMENT_COD_STATUS', 'True', 'Do you want to accept Cash On Delevery payments?', '6', '1', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
--6 - Shipping Flat
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Flat Shipping', 'MODULE_SHIPPING_FLAT_STATUS', 'True', 'Do you want to offer flat rate shipping?', '6', '0', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
--6 - Order Totals
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Shipping', 'MODULE_ORDER_TOTAL_SHIPPING_STATUS', 'true', 'Do you want to display the order shipping cost?', '6', '1','choice(''true''=''true'',''false''=''false'')', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Sub-Total', 'MODULE_ORDER_TOTAL_SUBTOTAL_STATUS', 'true', 'Do you want to display the order sub-total cost?', '6', '1','choice(''true''=''true'',''false''=''false'')', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Tax', 'MODULE_ORDER_TOTAL_TAX_STATUS', 'true', 'Do you want to display the order tax value?', '6', '1','choice(''true''=''true'',''false''=''false'')', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Total', 'MODULE_ORDER_TOTAL_TOTAL_STATUS', 'true', 'Do you want to display the total order value?', '6', '1','choice(''true''=''true'',''false''=''false'')', getdate());
...
-- 9
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Check stock level', 'STOCK_CHECK', 'true', 'Check to see if sufficent stock is available', '9', '1', 'choice(''true''=''true'',''false''=''false'')', getdate());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Subtract stock', 'STOCK_LIMITED', 'true', 'Subtract product in stock by product orders', '9', '2', 'choice(''true''=''true'',''false''=''false'')', getdate());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Allow Checkout', 'STOCK_ALLOW_CHECKOUT', 'true', 'Allow customer to checkout even if there is insufficient stock', '9', '3', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Send E-Mails', 'SEND_EMAILS', 'true', 'Send out e-mails', '12', '1', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
-----------------------------------------------------------------
-- KonaKart supplementary v8.5.0.0 demo database script for MySQL database
-----------------------------------------------------------------
--
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) VALUES  ('SMTP Secure',          'SMTP_SECURE',          'false',                       'Whether or not the SMTP server needs user authentication', '12', '3', getdate(), 'choice(''true''=''true'',''false''=''false'')');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) VALUES  ('Debug Email Sessions', 'DEBUG_EMAIL_SESSIONS', 'false',                       'Debug email sessions',                                    '12', '7', getdate(), 'choice(''true''=''true'',''false''=''false'')');
...
ALTER TABLE customers ADD custom1 NVARCHAR(128);
ALTER TABLE customers ADD custom2 NVARCHAR(128);
ALTER TABLE customers ADD custom3 NVARCHAR(128);
ALTER TABLE customers ADD custom4 NVARCHAR(128);
ALTER TABLE customers ADD custom5 NVARCHAR(128);

ALTER TABLE products ADD custom1 NVARCHAR(128);
ALTER TABLE products ADD custom2 NVARCHAR(128);
ALTER TABLE products ADD custom3 NVARCHAR(128);
ALTER TABLE products ADD custom4 NVARCHAR(128);
ALTER TABLE products ADD custom5 NVARCHAR(128);

ALTER TABLE manufacturers ADD custom1 NVARCHAR(128);
ALTER TABLE manufacturers ADD custom2 NVARCHAR(128);
ALTER TABLE manufacturers ADD custom3 NVARCHAR(128);
ALTER TABLE manufacturers ADD custom4 NVARCHAR(128);
ALTER TABLE manufacturers ADD custom5 NVARCHAR(128);

ALTER TABLE address_book ADD custom1 NVARCHAR(128);
ALTER TABLE address_book ADD custom2 NVARCHAR(128);
ALTER TABLE address_book ADD custom3 NVARCHAR(128);
ALTER TABLE address_book ADD custom4 NVARCHAR(128);
ALTER TABLE address_book ADD custom5 NVARCHAR(128);

ALTER TABLE orders ADD custom1 NVARCHAR(128);
ALTER TABLE orders ADD custom2 NVARCHAR(128);
ALTER TABLE orders ADD custom3 NVARCHAR(128);
ALTER TABLE orders ADD custom4 NVARCHAR(128);
ALTER TABLE orders ADD custom5 NVARCHAR(128);

ALTER TABLE reviews ADD custom1 NVARCHAR(128);
ALTER TABLE reviews ADD custom2 NVARCHAR(128);
ALTER TABLE reviews ADD custom3 NVARCHAR(128);

ALTER TABLE categories ADD custom1 NVARCHAR(128);
ALTER TABLE categories ADD custom2 NVARCHAR(128);
ALTER TABLE categories ADD custom3 NVARCHAR(128);

-- SSL
DELETE FROM configuration WHERE configuration_key = 'ENABLE_SSL';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enables SSL if set to true', 'ENABLE_SSL', 'false', 'Enables SSL if set to true to make the site secure', '16', '10', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Coupon Entry Field', 'DISPLAY_COUPON_ENTRY', 'true', 'During checkout the customer will be allowed to enter a coupon if set to true', '1', '22', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
CREATE TABLE promotion (
  ...
  cumulative smallint DEFAULT 0 NOT NULL,
  requires_coupon smallint DEFAULT 0 NOT NULL,
  start_date datetime,
  end_date datetime,
  ...
  customer_rule int,
  category_rule int,
  custom1 NVARCHAR(128),
  custom2 NVARCHAR(128),
  custom3 NVARCHAR(128),
  custom4 NVARCHAR(128),
  custom5 NVARCHAR(128),
  custom6 NVARCHAR(128),
  custom7 NVARCHAR(128),
  custom8 NVARCHAR(128),
  custom9 NVARCHAR(128),
  custom10 NVARCHAR(128),
  date_added datetime NOT NULL,
  last_modified datetime,
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enables One Page Checkout', 'ONE_PAGE_CHECKOUT', 'true', 'When set to true, it enables the one page checkout functionality rather than 3 separate pages', '1', '23', 'choice(''true''=''true'',''false''=''false'')', getdate());
DELETE FROM configuration WHERE configuration_key = 'ALLOW_CHECKOUT_WITHOUT_REGISTRATION';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enables Checkout Without Registration', 'ALLOW_CHECKOUT_WITHOUT_REGISTRATION', 'true', 'When set to true, and one page checkout is enabled, it allows customers to checkout without registering', '1', '24', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
ALTER TABLE products ADD products_sku NVARCHAR(255);
...
ALTER TABLE products ADD products_file_path NVARCHAR(255);
ALTER TABLE products ADD products_content_type NVARCHAR(128);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Delete record on expiration', 'DD_DELETE_ON_EXPIRATION', 'true', 'When the download link expires, delete the database table record', 19, 3, 'choice(''true''=''true'',''false''=''false'')',getdate());
DELETE FROM configuration WHERE configuration_key = 'DD_DOWNLOAD_AS_ATTACHMENT';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Download as an attachment', 'DD_DOWNLOAD_AS_ATTACHMENT', 'true', 'Download the file as an attachment rather than viewing in the browser', 19, 4, 'choice(''true''=''true'',''false''=''false'')',getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Show Invisible Products', 'SHOW_INVISIBLE_PRODUCTS_IN_ADM', 'true', 'Show invisible products in the Admin App', 9, 4, 'choice(''true''=''true'',''false''=''false'')', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Send Order Confirmation E-Mails', 'SEND_ORDER_CONF_EMAIL', 'true', 'Send out an e-mail when an order is saved or state changes', '12', '8', 'choice(''true''=''true'',''false''=''false'')', getdate());
DELETE FROM configuration WHERE configuration_key = 'SEND_STOCK_REORDER_EMAIL';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Send Stock Reorder E-Mails', 'SEND_STOCK_REORDER_EMAIL', 'true', 'Send out an e-mail when the stock level of a product falls below a certain value', '12', '9', 'choice(''true''=''true'',''false''=''false'')', getdate());
DELETE FROM configuration WHERE configuration_key = 'SEND_WELCOME_EMAIL';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Send Welcome E-Mails', 'SEND_WELCOME_EMAIL', 'true', 'Send out a welcome e-mail when a customer registers to use the cart', '12', '10', 'choice(''true''=''true'',''false''=''false'')', getdate());
DELETE FROM configuration WHERE configuration_key = 'SEND_NEW_PASSWORD_EMAIL';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Send New Password E-Mails', 'SEND_NEW_PASSWORD_EMAIL', 'true', 'Send out an e-mail containing a new password when requested by a customer', '12', '11', 'choice(''true''=''true'',''false''=''false'')', getdate());

-- Add extra image fields to product
ALTER TABLE products ADD products_image2 NVARCHAR(64);
ALTER TABLE products ADD products_image3 NVARCHAR(64);
ALTER TABLE products ADD products_image4 NVARCHAR(64);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Allow Free Shipping', 'MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING', 'false', 'Do you want to allow free shipping?', '6', '3','choice(''true''=''true'',''false''=''false'')', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Security on API Calls', 'API_CALL_SECURITY', 'false', 'Do you want to enable security on API calls ?', '18', '5','choice(''true''=''true'',''false''=''false'')' , getdate());
...
ALTER TABLE orders ALTER COLUMN customers_country NVARCHAR(64);
ALTER TABLE orders ALTER COLUMN billing_country NVARCHAR(64);
ALTER TABLE orders ALTER COLUMN delivery_country NVARCHAR(64);
...
ALTER TABLE orders_products ADD custom1 NVARCHAR(128);
ALTER TABLE orders_products ADD custom2 NVARCHAR(128);
ALTER TABLE orders_products ADD custom3 NVARCHAR(128);
ALTER TABLE orders_products ADD custom4 NVARCHAR(128);
ALTER TABLE orders_products ADD custom5 NVARCHAR(128);

ALTER TABLE customers_basket ADD custom1 NVARCHAR(128);
ALTER TABLE customers_basket ADD custom2 NVARCHAR(128);
ALTER TABLE customers_basket ADD custom3 NVARCHAR(128);
ALTER TABLE customers_basket ADD custom4 NVARCHAR(128);
ALTER TABLE customers_basket ADD custom5 NVARCHAR(128);
...
ALTER TABLE kk_customer_group ADD custom1 NVARCHAR(128);
ALTER TABLE kk_customer_group ADD custom2 NVARCHAR(128);
ALTER TABLE kk_customer_group ADD custom3 NVARCHAR(128);
ALTER TABLE kk_customer_group ADD custom4 NVARCHAR(128);
ALTER TABLE kk_customer_group ADD custom5 NVARCHAR(128);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Run Initial Customer Search', 'CUST_PANEL_RUN_INITIAL_SEARCH', 'true', 'Set to true to always run the initial Customer Search', '21', '12', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Clear button on Customer Panel removes results', 'CUST_PANEL_CLEAR_REMOVES_RESULTS', 'false', 'Set to true to clear both the search criteria AND the results when the clear button is clicked', '21', '13', 'choice(''true''=''true'',''false''=''false'')', getdate());



-- Add the ENABLE_ANALYTICS config variable
DELETE FROM configuration WHERE configuration_key = 'ENABLE_ANALYTICS';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Analytics', 'ENABLE_ANALYTICS', 'false', 'Enable analytics to have the analytics.code (in your Messages.properties file) inserted into the JSPs', '20', '3', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Use Solr Search Server','USE_SOLR_SEARCH','false','Use Solr search server to search for products','24', '1', 'choice(''true''=''true'',''false''=''false'')', getdate());
DELETE FROM configuration WHERE configuration_key = 'SOLR_URL';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Base URL of Solr Search Server','SOLR_URL','http://localhost:8983/solr/konakart','Base URL of Solr Search Server','24', '2', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Store Credit Card Details', 'STORE_CC_DETAILS', 'false', 'Store credit card details', 9, 4, 'choice(''true''=''true'',''false''=''false'')', getdate());
...
CREATE TABLE kk_store (
  ...
  store_desc NVARCHAR(128) NOT NULL,
  store_enabled smallint NOT NULL,
  store_under_maint smallint NOT NULL,
  store_deleted smallint NOT NULL,
  store_template smallint NOT NULL,
  store_admin_email NVARCHAR(96),
  store_css_filename NVARCHAR(128),
  store_logo_filename NVARCHAR(128),
  store_url NVARCHAR(128),
  store_home NVARCHAR(64),
...
CREATE TABLE kk_wishlist (
  ...
  date_added datetime NOT NULL,
  customers_firstname NVARCHAR(32),
  customers_lastname NVARCHAR(32),
  customers_dob datetime,
  customers_city NVARCHAR(32),
  customers_state NVARCHAR(32),
  custom1 NVARCHAR(128),
  custom2 NVARCHAR(128),
  custom3 NVARCHAR(128),
...
ALTER TABLE orders ADD orders_number NVARCHAR(128);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display Order Number', 'ADMIN_APP_ORDERS_DISPLAY_ORDER_NUM', '', 'When this is set, the order number is displayed in the orders panel rather than the order id', '21', '24', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
ALTER TABLE zones ADD custom1 NVARCHAR(128);
ALTER TABLE zones ADD custom2 NVARCHAR(128);
ALTER TABLE zones ADD custom3 NVARCHAR(128);
...
ALTER TABLE orders ADD tracking_number NVARCHAR(128);
...
ALTER TABLE orders_products ADD products_sku NVARCHAR(255);
ALTER TABLE customers_basket ADD products_sku NVARCHAR(255);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Allow Cust Group Change eMail', 'ADMIN_APP_ALLOW_GROUP_CHANGE_MAIL', 'true', 'When this is set, a popup window appears when the group of a customer is changed to allow you to send an eMail', '21', '28', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
ALTER TABLE kk_wishlist ADD customers1_firstname NVARCHAR(32);
ALTER TABLE kk_wishlist ADD customers1_lastname NVARCHAR(32);
ALTER TABLE kk_wishlist ADD link_url NVARCHAR(255);
...
ALTER TABLE kk_wishlist_item ADD comments NVARCHAR(255);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Gift Registry functionality', 'ENABLE_GIFT_REGISTRY', 'false', 'When set to true, gift registry functionality is enabled in the application', '1', '26', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Customer WishList Tag functionality', 'ENABLE_CUSTOMER_WISHLIST_TAGS', 'false', 'When set to true, the application sets customer wish list tags', '5', '8', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Enable Reward Points', 'ENABLE_REWARD_POINTS', 'false', 'During checkout the customer will be allowed to enter reward points if set to true', '26', '1', 'choice(''true''=''true'',''false''=''false'')', getdate(), store_id FROM configuration WHERE configuration_key = 'STORE_COUNTRY';
...
ALTER TABLE customers ADD customers_locale NVARCHAR(16);
ALTER TABLE orders ADD customers_locale NVARCHAR(16);

-- To enable/disable the new Rich Text Product Description Editor
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Use Rich Text Editor', 'RICH_TEXT_EDITOR', 'true', 'If true the Rich Text Editor is used for product descriptions, otherwise the Plain Text Editor is used', '9', '12', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
ALTER TABLE orders_returns ADD orders_number NVARCHAR(128);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Automatically Enable Product', 'STOCK_ENABLE_PRODUCT', 'false', 'Automatically enable a product if quantity is set to a positive number', '9', '4', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
ALTER TABLE products ADD custom6 NVARCHAR(128);
ALTER TABLE products ADD custom7 NVARCHAR(128);
ALTER TABLE products ADD custom8 NVARCHAR(128);
ALTER TABLE products ADD custom9 NVARCHAR(128);
ALTER TABLE products ADD custom10 NVARCHAR(128);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Allow multiple basket entries', 'ALLOW_MULTIPLE_BASKET_ENTRIES', 'false', 'When set, allow the same product to be entered into the basket more than once without updating the quantity of the existing one', '9', '11', 'choice(''true''=''true'',''false''=''false'')', getdate());

-- Addition of extra telephone and eMail attributes
ALTER TABLE customers ADD customers_telephone_1 NVARCHAR(32);
ALTER TABLE address_book ADD entry_telephone NVARCHAR(32);
ALTER TABLE address_book ADD entry_telephone_1 NVARCHAR(32);
ALTER TABLE address_book ADD entry_email_address NVARCHAR(96);
ALTER TABLE orders ADD customers_telephone_1 NVARCHAR(32);
ALTER TABLE orders ADD delivery_telephone NVARCHAR(32);
ALTER TABLE orders ADD delivery_telephone_1 NVARCHAR(32);
ALTER TABLE orders ADD delivery_email_address NVARCHAR(96);
ALTER TABLE orders ADD billing_telephone NVARCHAR(32);
ALTER TABLE orders ADD billing_telephone_1 NVARCHAR(32);
ALTER TABLE orders ADD billing_email_address NVARCHAR(96);
...
ALTER TABLE address_book ADD entry_street_address_1 NVARCHAR(64);
ALTER TABLE orders ADD customers_street_address_1 NVARCHAR(64);
ALTER TABLE orders ADD delivery_street_address_1 NVARCHAR(64);
ALTER TABLE orders ADD billing_street_address_1 NVARCHAR(64);
...
ALTER TABLE products_attributes ADD custom1 NVARCHAR(128);
ALTER TABLE products_attributes ADD custom2 NVARCHAR(128);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Warn of Duplicate SKUs', 'ADMIN_APP_WARN_OF_DUPLICATE_SKUS', 'false', 'Issue warning in Admin App of duplicate SKUs', '21', '32', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
ALTER TABLE orders ADD shipping_service_code NVARCHAR(128);
...
ALTER TABLE languages ADD locale NVARCHAR(10);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Fetch Descriptions Separately', 'FETCH_PRODUCT_DESCRIPTIONS_SEPARATELY', 'false', 'Fetch Product Descriptions Separately', '9', '30', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
ALTER TABLE products_description ALTER COLUMN products_name NVARCHAR(255);
...
ALTER TABLE orders_products ADD tax_code NVARCHAR(64);

--Add lifecycle_id to order table
ALTER TABLE orders ADD lifecycle_id VARCHAR(128);

-- Add custom fields to product to stores
ALTER TABLE kk_product_to_stores ADD custom1 NVARCHAR(128);
ALTER TABLE kk_product_to_stores ADD custom2 NVARCHAR(128);
ALTER TABLE kk_product_to_stores ADD custom3 NVARCHAR(128);
...
ALTER TABLE orders_total ADD custom1 NVARCHAR(128);
ALTER TABLE orders_total ADD custom2 NVARCHAR(128);
ALTER TABLE orders_total ADD custom3 NVARCHAR(128);

-- Add creator field to order
ALTER TABLE orders ADD order_creator NVARCHAR(128);
...
-- Extend the size of the products_name field
ALTER TABLE orders_products ALTER COLUMN products_name NVARCHAR(255);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Digital Downloads', 'MODULE_SHIPPING_DD_STATUS', 'True', 'Set it to true if you sell digital downloads', '6', '0', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
ALTER TABLE ipn_history ADD custom1 NVARCHAR(128);
ALTER TABLE ipn_history ADD custom2 NVARCHAR(128);
ALTER TABLE ipn_history ADD custom3 NVARCHAR(128);
ALTER TABLE ipn_history ADD custom4 NVARCHAR(128);
...
ALTER TABLE orders_products_attributes ALTER COLUMN products_options_values NVARCHAR(64);
...
ALTER TABLE address_book ALTER COLUMN entry_firstname NVARCHAR(32) NULL;
ALTER TABLE address_book ALTER COLUMN entry_lastname NVARCHAR(32) NULL;

-- Table for KonaKart Config Values
DROP TABLE kk_config;
CREATE TABLE kk_config (
  kk_config_id int NOT NULL identity(1,1),
  kk_config_key NVARCHAR(16),
  kk_config_value NVARCHAR(256),
  date_added datetime,
...
ALTER TABLE orders ADD affiliate_id NVARCHAR(128);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Delete from index on commit','SOLR_DELETE_ON_COMMIT','true','On commit, delete from index products marked for deletion','24', '5', 'choice(''true''=''true'',''false''=''false'')', getdate(), '0');
...
ALTER TABLE orders ADD payment_module_subcode NVARCHAR(64);
...
-- Add extra fields to products table
ALTER TABLE products ADD product_image_dir NVARCHAR(64);
...
ALTER TABLE orders ALTER COLUMN customers_name NVARCHAR(66);
ALTER TABLE orders ALTER COLUMN delivery_name NVARCHAR(66);
ALTER TABLE orders ALTER COLUMN billing_name NVARCHAR(66);
...
ALTER TABLE products_description ADD customd1 NVARCHAR(2);
ALTER TABLE products_description ADD customd2 NVARCHAR(2);
ALTER TABLE products_description ADD customd3 NVARCHAR(2);
ALTER TABLE products_description ADD customd4 NVARCHAR(2);
ALTER TABLE products_description ADD customd5 NVARCHAR(2);
ALTER TABLE products_description ADD customd6 NVARCHAR(2);
...
ALTER TABLE orders ADD store_name NVARCHAR(64);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Storefront force login','APP_FORCE_LOOGIN','false','Set to true to force customers to login in order to be able to use the storefront application.','1', '38', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
...
ALTER TABLE customers_basket_attrs ADD customer_string NVARCHAR(512);
ALTER TABLE orders_products_attributes ADD customer_price DECIMAL(15,2);
ALTER TABLE orders_products_attributes ADD customer_string NVARCHAR(512);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Cache Products','CACHE_PRODUCTS','true','Set to true to Cache Products in memory.','11', '15', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Cache Product Images','CACHE_PRODUCT_IMAGES','true','Set to true to Cache Product Image Names in memory.','11', '20', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Enable "Other" Gender', 'ENABLE_OTHER_GENDER', 'false', 'Enable "Other" gender in addition to Male and Female', '5', '1', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
...
ALTER TABLE customers ADD tax_identifier NVARCHAR(64);
ALTER TABLE customers ADD tax_exemption NVARCHAR(64);
ALTER TABLE customers ADD tax_entity NVARCHAR(64);
ALTER TABLE customers ADD ext_reference_1 NVARCHAR(64);
ALTER TABLE customers ADD ext_reference_2 NVARCHAR(64);

-- Config variable for displaying tax id
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Tax Id','ACCOUNT_TAX_ID','false','Display tax id in the customers account','5', '3', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
...
CREATE TABLE kk_content_type (
  id INT NOT NULL identity(1,1),
  content_type_id INT DEFAULT 0 NOT NULL,
  custom1 NVARCHAR(32),
  custom2 NVARCHAR(32),
  date_added DATETIME,
  store_id VARCHAR(64),
...
CREATE INDEX i_content_type_id_kk_content_type ON kk_content_type (content_type_id);
...
CREATE INDEX i_content_type_id_kk_content_type_desc ON kk_content_type_desc (content_type_id);
...
CREATE TABLE kk_content (
  ...
  object_id INT,
  obj_type_id INT,
  click_url NVARCHAR(256),
  date_from DATETIME,
  date_to DATETIME,
  enabled smallint DEFAULT 0 NOT NULL,
  expression_id INT DEFAULT 0 NOT NULL,
...
CREATE INDEX i_content_id_kk_content ON kk_content (content_id);
CREATE INDEX i_search_key_kk_content ON kk_content (search_key);
...
CREATE INDEX i_content_id_kk_content_desc ON kk_content_desc (content_id);

-- Populate the Content tables
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (1, getdate());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (2, getdate());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (3, getdate());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (4, getdate());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (5, getdate());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (6, getdate());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (7, getdate());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (8, getdate());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (9, getdate());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (10, getdate());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (11, getdate());
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (12, getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (1, 1, 'Top Banner', 'Top Banner - Top of store home page', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (1, 2, 'Top Banner', 'Top Banner - Top of store Startseite', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (1, 3, 'Top Banner', 'Top Banner - Inicio de tienda de la página principal', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (1, 4, 'Top Banner', 'Top Banner - Top of Home Page da loja', getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (2, 1, 'Sub Banner', 'Sub Banner - Secondary banner', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (2, 2, 'Sub Banner', 'Sub Banner - Sekundär banner', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (2, 3, 'Sub Banner', 'Sub Banner - banner Secundaria', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (2, 4, 'Sub Banner', 'Sub Banner - bandeira Secundário', getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (3, 1, 'Category Banner', 'Category Banner - Top of category pages', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (3, 2, 'Kategorie Banner', 'Kategorie Banner - Top of Kategorieseiten', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (3, 3, 'Categoria Banner', 'Categoría Banner - Inicio de las páginas de categorías', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (3, 4, 'Categoria Banner', 'Categoria Banner - Top de páginas da categoria', getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (4, 1, 'Category Sub Banner', 'Category Sub Banner - Secondary Category Banner', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (4, 2, 'Kategorie Unter Banner', 'Kategorie Unter Banner - Sekundäre Kategorie Banner', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (4, 3, 'Categoría Sub Banner', 'Categoría Sub Banner - Categoría Secundaria Banner', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (4, 4, 'Categoría Sub Banner', 'Categoria Sub Banner - Categoria Secundária Bandeira', getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (5, 1, 'About Us', 'About Us Text', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (5, 2, 'über uns', 'über uns', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (5, 3, 'sobre nosotros', 'sobre nosotros', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (5, 4, 'sobre nós', 'sobre nós', getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (6, 1, 'Shipping and Handling', 'Shipping and Handling Text', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (6, 2, 'Versand-und Bearbeitungs', 'Versand-und Bearbeitungs', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (6, 3, 'Envío y manipulación', 'Envío y manipulación', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (6, 4, 'Envio e manipulação', 'Envio e manipulação', getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (7, 1, 'Product Returns', 'Product Returns Text', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (7, 2, 'Produktrückgabe', 'Produktrückgabe', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (7, 3, 'Devolución de productos', 'Devolución de productos', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (7, 4, 'Devoluções de produtos', 'Devoluções de produtos', getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (8, 1, 'International Orders', 'International Orders Text', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (8, 2, 'International Orders', 'International Orders Text', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (8, 3, 'Pedidos internacionales', 'Pedidos internacionales', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (8, 4, 'Encomendas internacionais', 'Encomendas internacionais', getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (9, 1, 'Privacy Policy', 'Privacy Policy Text', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (9, 2, 'Datenschutz-Bestimmungen', 'Datenschutz-Bestimmungen', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (9, 3, 'Política de privacidad', 'política de privacidad', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (9, 4, 'Política De Privacidade', 'Política De Privacidade', getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (10, 1, 'Terms of use', 'Terms of use Text', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (10, 2, 'Nutzungsbedingungen', 'Nutzungsbedingungen', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (10, 3, 'Condiciones de uso', 'Condiciones de uso', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (10, 4, 'Termos de uso', 'Termos de uso', getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (11, 1, 'Help', 'Help Text', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (11, 2, 'Hilfe', 'Hilfe', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (11, 3, '¡Ayuda', '¡Ayuda', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (11, 4, 'Socorro', 'Socorro', getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (12, 1, 'Contact Us', 'Contact Us Text', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (12, 2, 'Kontaktdetails', 'Kontaktdetails', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (12, 3, 'Detalles de contacto', 'Detalles de contacto', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (12, 4, 'Detalhes de Contato', 'Detalhes de Contato', getdate());

-- Category Banners

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (1, 3, 'SelectProd.action?prodId={OBJ_ID}', 'Computer Peripherals', 31, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (1, 1, 'logitech.png', 'logitech-medium.png', 'logitech-small.png', 'Logitech Keyboard', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (1, 2, 'logitech.png', 'logitech-medium.png', 'logitech-small.png', 'Logitech Keyboard', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (1, 3, 'logitech.png', 'logitech-medium.png', 'logitech-small.png', 'Logitech Keyboard', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (1, 4, 'logitech.png', 'logitech-medium.png', 'logitech-small.png', 'Logitech Keyboard', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (2, 4, 'SelectProd.action?prodId={OBJ_ID}', 'Computer Peripherals', 27, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (2, 1, 'hp-photosmart.png', 'hp-photosmart-medium.png', 'hp-photosmart-small.png', 'HP Photosmart 5510', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (2, 2, 'hp-photosmart.png', 'hp-photosmart-medium.png', 'hp-photosmart-small.png', 'HP Photosmart 5510', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (2, 3, 'hp-photosmart.png', 'hp-photosmart-medium.png', 'hp-photosmart-small.png', 'HP Photosmart 5510', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (2, 4, 'hp-photosmart.png', 'hp-photosmart-medium.png', 'hp-photosmart-small.png', 'HP Photosmart 5510', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (3, 4, '', 'Computer Peripherals', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (3, 1, 'deals-of-the-week.png', 'deals-of-the-week-medium.png', 'deals-of-the-week-small.png', 'Deals of the Week', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (3, 2, 'deals-of-the-week.png', 'deals-of-the-week-medium.png', 'deals-of-the-week-small.png', 'Deals of the Week', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (3, 3, 'deals-of-the-week.png', 'deals-of-the-week-medium.png', 'deals-of-the-week-small.png', 'Deals of the Week', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (3, 4, 'deals-of-the-week.png', 'deals-of-the-week-medium.png', 'deals-of-the-week-small.png', 'Deals of the Week', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (4, 3, 'SelectProd.action?prodId={OBJ_ID}', 'Games', 63, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (4, 1, 'black-ops-2.png', 'black-ops-2-medium.png', 'black-ops-2-small.png', 'Black Ops 2', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (4, 2, 'black-ops-2.png', 'black-ops-2-medium.png', 'black-ops-2-small.png', 'Black Ops 2', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (4, 3, 'black-ops-2.png', 'black-ops-2-medium.png', 'black-ops-2-small.png', 'Black Ops 2', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (4, 4, 'black-ops-2.png', 'black-ops-2-medium.png', 'black-ops-2-small.png', 'Black Ops 2', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (5, 4, 'SelectProd.action?prodId={OBJ_ID}', 'Games', 21, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (5, 1, 'swat-3.png', 'swat-3-medium.png', 'swat-3-small.png', 'Swat-3', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (5, 2, 'swat-3.png', 'swat-3-medium.png', 'swat-3-small.png', 'Swat-3', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (5, 3, 'swat-3.png', 'swat-3-medium.png', 'swat-3-small.png', 'Swat-3', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (5, 4, 'swat-3.png', 'swat-3-medium.png', 'swat-3-small.png', 'Swat-3', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (6, 4, '', 'Games', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (6, 1, 'winter-deals.png', 'winter-deals-medium.png', 'winter-deals-small.png', 'Winter Deals', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (6, 2, 'winter-deals.png', 'winter-deals-medium.png', 'winter-deals-small.png', 'Winter Deals', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (6, 3, 'winter-deals.png', 'winter-deals-medium.png', 'winter-deals-small.png', 'Winter Deals', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (6, 4, 'winter-deals.png', 'winter-deals-medium.png', 'winter-deals-small.png', 'Winter Deals', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (7, 3, 'SelectProd.action?prodId={OBJ_ID}', 'DVD Movies', 20, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (7, 1, 'dark-knight.png', 'dark-knight-medium.png', 'dark-knight-small.png', 'Dark Night', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (7, 2, 'dark-knight.png', 'dark-knight-medium.png', 'dark-knight-small.png', 'Dark Night', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (7, 3, 'dark-knight.png', 'dark-knight-medium.png', 'dark-knight-small.png', 'Dark Night', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (7, 4, 'dark-knight.png', 'dark-knight-medium.png', 'dark-knight-small.png', 'Dark Night', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (8, 4, 'SelectProd.action?prodId={OBJ_ID}', 'DVD Movies', 11, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (8, 1, 'harry-potter.png', 'harry-potter-medium.png', 'harry-potter-small.png', 'Harry Potter', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (8, 2, 'harry-potter.png', 'harry-potter-medium.png', 'harry-potter-small.png', 'Harry Potter', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (8, 3, 'harry-potter.png', 'harry-potter-medium.png', 'harry-potter-small.png', 'Harry Potter', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (8, 4, 'harry-potter.png', 'harry-potter-medium.png', 'harry-potter-small.png', 'Harry Potter', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (9, 4, '', 'DVD Movies', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (9, 1, 'movie-deals.png', 'movie-deals-medium.png', 'movie-deals-small.png', 'Movie Deals', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (9, 2, 'movie-deals.png', 'movie-deals-medium.png', 'movie-deals-small.png', 'Movie Deals', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (9, 3, 'movie-deals.png', 'movie-deals-medium.png', 'movie-deals-small.png', 'Movie Deals', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (9, 4, 'movie-deals.png', 'movie-deals-medium.png', 'movie-deals-small.png', 'Movie Deals', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (10, 3, 'SelectProd.action?prodId={OBJ_ID}', 'Electronics', 34, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (10, 1, 'kindle-fire-hd.jpg', 'kindle-fire-hd-medium.jpg', 'kindle-fire-hd-small.jpg', 'Kindle Fire', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (10, 2, 'kindle-fire-hd.jpg', 'kindle-fire-hd-medium.jpg', 'kindle-fire-hd-small.jpg', 'Kindle Fire', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (10, 3, 'kindle-fire-hd.jpg', 'kindle-fire-hd-medium.jpg', 'kindle-fire-hd-small.jpg', 'Kindle Fire', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (10, 4, 'kindle-fire-hd.jpg', 'kindle-fire-hd-medium.jpg', 'kindle-fire-hd-small.jpg', 'Kindle Fire', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (11, 4, '', 'Electronics', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (11, 1, 'xbox.png', 'xbox-medium.png', 'xbox-small.png', 'Xbox', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (11, 2, 'xbox.png', 'xbox-medium.png', 'xbox-small.png', 'Xbox', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (11, 3, 'xbox.png', 'xbox-medium.png', 'xbox-small.png', 'Xbox', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (11, 4, 'xbox.png', 'xbox-medium.png', 'xbox-small.png', 'Xbox', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (12, 4, '', 'Electronics', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (12, 1, 'electronics-sale.png', 'electronics-sale-medium.png', 'electronics-sale-small.png', 'Electronics Sale', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (12, 2, 'electronics-sale.png', 'electronics-sale-medium.png', 'electronics-sale-small.png', 'Electronics Sale', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (12, 3, 'electronics-sale.png', 'electronics-sale-medium.png', 'electronics-sale-small.png', 'Electronics Sale', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (12, 4, 'electronics-sale.png', 'electronics-sale-medium.png', 'electronics-sale-small.png', 'Electronics Sale', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (13, 3, 'SelectProd.action?prodId={OBJ_ID}', 'Home & Garden', 33, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (13, 1, 'delonghi.png', 'delonghi-medium.png', 'delonghi-small.png', 'DeLonghi Coffee Maker', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (13, 2, 'delonghi.png', 'delonghi-medium.png', 'delonghi-small.png', 'DeLonghi Coffee Maker', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (13, 3, 'delonghi.png', 'delonghi-medium.png', 'delonghi-small.png', 'DeLonghi Coffee Maker', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (13, 4, 'delonghi.png', 'delonghi-medium.png', 'delonghi-small.png', 'DeLonghi Coffee Maker', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (14, 4, 'SelectProd.action?prodId={OBJ_ID}', 'Home & Garden', 39, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (14, 1, 'rotak-40.png', 'rotak-40-medium.png', 'rotak-40-small.png', 'Rotak 40', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (14, 2, 'rotak-40.png', 'rotak-40-medium.png', 'rotak-40-small.png', 'Rotak 40', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (14, 3, 'rotak-40.png', 'rotak-40-medium.png', 'rotak-40-small.png', 'Rotak 40', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (14, 4, 'rotak-40.png', 'rotak-40-medium.png', 'rotak-40-small.png', 'Rotak 40', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (15, 4, '', 'Home & Garden', 39, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (15, 1, 'gifts-for-the-home.png', 'gifts-for-the-home-medium.png', 'gifts-for-the-home-small.png', 'Gifts for the home', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (15, 2, 'gifts-for-the-home.png', 'gifts-for-the-home-medium.png', 'gifts-for-the-home-small.png', 'Gifts for the home', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (15, 3, 'gifts-for-the-home.png', 'gifts-for-the-home-medium.png', 'gifts-for-the-home-small.png', 'Gifts for the home', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (15, 4, 'gifts-for-the-home.png', 'gifts-for-the-home-medium.png', 'gifts-for-the-home-small.png', 'Gifts for the home', getdate());

-- Top Banners on Home Page

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (16, 1, 'SelectProd.action?prodId={OBJ_ID}', 34, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (16, 1, 'home_kindle-fire-hd.jpg', 'home_kindle-fire-hd-medium.jpg', 'home_kindle-fire-hd-small.jpg', 'Kindle Fire', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (16, 2, 'home_kindle-fire-hd.jpg', 'home_kindle-fire-hd-medium.jpg', 'home_kindle-fire-hd-small.jpg', 'Kindle Fire', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (16, 3, 'home_kindle-fire-hd.jpg', 'home_kindle-fire-hd-medium.jpg', 'home_kindle-fire-hd-small.jpg', 'Kindle Fire', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (16, 4, 'home_kindle-fire-hd.jpg', 'home_kindle-fire-hd-medium.jpg', 'home_kindle-fire-hd-small.jpg', 'Kindle Fire', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (17, 1, 'SelectProd.action?prodId={OBJ_ID}', 33, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (17, 1, 'home_delonghi.png', 'home_delonghi-medium.png', 'home_delonghi-small.png', 'DeLonghi Coffee Maker', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (17, 2, 'home_delonghi.png', 'home_delonghi-medium.png', 'home_delonghi-small.png', 'DeLonghi Coffee Maker', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (17, 3, 'home_delonghi.png', 'home_delonghi-medium.png', 'home_delonghi-small.png', 'DeLonghi Coffee Maker', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (17, 4, 'home_delonghi.png', 'home_delonghi-medium.png', 'home_delonghi-small.png', 'DeLonghi Coffee Maker', getdate());

-- Sub-Banners on Home Page

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (18, 2, 'ShowSpecials.action', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (18, 1, 'home_electronics-sale.jpg', 'Electronics Sale', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (18, 2, 'home_electronics-sale.jpg', 'Electronics Sale', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (18, 3, 'home_electronics-sale.jpg', 'Electronics Sale', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (18, 4, 'home_electronics-sale.jpg', 'Electronics Sale', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (19, 2, 'SelectCat.action?catId={OBJ_ID}', 23, 2, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (19, 1, 'home_electronics-sale-2.jpg', 'Electronics Sale', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (19, 2, 'home_electronics-sale-2.jpg', 'Electronics Sale', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (19, 3, 'home_electronics-sale-2.jpg', 'Electronics Sale', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (19, 4, 'home_electronics-sale-2.jpg', 'Electronics Sale', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (20, 2, 'SelectCat.action?catId={OBJ_ID}', 24, 2, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (20, 1, 'home_gifts-for-the-home.jpg', 'Gifts for the home', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (20, 2, 'home_gifts-for-the-home.jpg', 'Gifts for the home', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (20, 3, 'home_gifts-for-the-home.jpg', 'Gifts for the home', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (20, 4, 'home_gifts-for-the-home.jpg', 'Gifts for the home', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (21, 2, 'SelectProd.action?prodId={OBJ_ID}', 32, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (21, 1, 'home_windows-8.jpg', 'Windows-8', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (21, 2, 'home_windows-8.jpg', 'Windows-8', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (21, 3, 'home_windows-8.jpg', 'Windows-8', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (21, 4, 'home_windows-8.jpg', 'Windows-8', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (22, 2, 'SelectProd.action?prodId={OBJ_ID}', 35, 1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (22, 1, 'home_iphone-5.jpg', 'iPhone 5', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (22, 2, 'home_iphone-5.jpg', 'iPhone 5', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (22, 3, 'home_iphone-5.jpg', 'iPhone 5', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, title, date_added) VALUES (22, 4, 'home_iphone-5.jpg', 'iPhone 5', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (23, 5, '', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (23, 1, 'Add your About Us information here.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (23, 2, 'Fügen Sie Ihre Über uns Informationen hier', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (23, 3, 'Añade tu Quiénes somos información aquí', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (23, 4, 'Adicione a sua Quem somos informações aqui', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (24, 6, '', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (24, 1, 'Add your Shipping and Handling information here.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (24, 2, 'Fügen Sie Ihre Versandinformationen hier', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (24, 3, 'Agregue su envío y manipulación de información aquí', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (24, 4, 'Adicione sua informação de envio aqui', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (25, 7, '', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (25, 1, 'Add your Returns information here.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (25, 2, 'Fügen Sie Ihre Versandkosten Informationen finden Sie hier', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (25, 3, 'Añade tu información Devoluciones aquí', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (25, 4, 'Adicione sua informação Returns aqui', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (26, 8, '', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (26, 1, 'Add your International Orders information here.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (26, 2, 'Fügen Sie hier Ihre Informationen Internationale Bestellungen.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (26, 3, 'Añade tu información Internacional Órdenes aquí.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (26, 4, 'Adicione sua informação Internacional Ordens aqui.', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (27, 9, '', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (27, 1, 'Add your Privacy Policy here.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (27, 2, 'Fügen Sie Ihren Datenschutz hier.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (27, 3, 'Agregue su política de privacidad aquí.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (27, 4, 'Adicione a sua Política de Privacidade aqui.', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (28, 10, '', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (28, 1, 'Add your Terms of Use here.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (28, 2, 'Fügen Sie Ihr Nutzungsbedingungen hier', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (28, 3, 'Añada sus Términos de Uso aquí', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (28, 4, 'Adicione seus Termos de Uso aqui', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (29, 11, '', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (29, 1, 'Add your Help information here.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (29, 2, 'Fügen Sie hier Ihre Informationen Hilfe.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (29, 3, 'Añade tu información de ayuda aquí.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (29, 4, 'Adicione sua informação ajuda aqui.', getdate());

INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (30, 12, '', 0, 0, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (30, 1, 'Add your Contact information here.', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (30, 2, 'Fügen Sie Ihre Kontaktinformationen hier', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (30, 3, 'Añadir su información de contacto aquí', getdate());
INSERT INTO kk_content_desc (content_id, language_id, content, date_added) VALUES (30, 4, 'Adicione sua informação de contato aqui', getdate());

-- New API calls for Content
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getContents', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getContent', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('insertContent', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteContent', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('updateContent', '', getdate());

INSERT INTO kk_api_call (name, description, date_added) VALUES ('getContentTypes', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getContentType', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('insertContentType', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteContentType', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('updateContentType', '', getdate());

-- New Admin App Panels for Content

INSERT INTO kk_panel (code, description, date_added) VALUES ('kk_panel_contentTypes','Content Types', getdate());

-- Add Content Type Panel access to all roles that can access the 'kk_panel_storeConfiguration' panel
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, p2.panel_id, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p, kk_panel p2 where rtp.panel_id=p.panel_id and p.code='kk_panel_storeConfiguration' and p2.code='kk_panel_contentTypes';

INSERT INTO kk_panel (code, description, date_added) VALUES ('kk_panel_content','Content', getdate());

-- Add Content Panel access to all roles that can access the 'kk_panel_storeConfiguration' panel
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, p2.panel_id, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p, kk_panel p2 where rtp.panel_id=p.panel_id and p.code='kk_panel_storeConfiguration' and p2.code='kk_panel_content';

INSERT INTO kk_panel (code, description, date_added) VALUES ('kk_panel_editContent','Edit Content', getdate());

-- Add Content Panel access to all roles that can access the 'kk_panel_storeConfiguration' panel
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, p2.panel_id, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p, kk_panel p2 where rtp.panel_id=p.panel_id and p.code='kk_panel_storeConfiguration' and p2.code='kk_panel_editContent';

-- Add a search key to categories
ALTER TABLE categories ADD search_key varchar(128);
UPDATE categories SET search_key = categories_name FROM categories_description CD, categories C WHERE C.categories_id = CD.categories_id AND CD.language_id IN (SELECT languages_id FROM languages L, configuration CON WHERE code=configuration_value AND configuration_key='DEFAULT_LANGUAGE');

DELETE FROM configuration WHERE configuration_key = 'ENABLE_KONAKART_CONTENT';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api, store_id) SELECT 'Enable KonaKart Content', 'ENABLE_KONAKART_CONTENT', 'false', 'When set to true, KonaKart Content is enabled', '1', '10', 'choice(''true''=''true'',''false''=''false'')', getdate(), 1, store_id FROM configuration WHERE configuration_key = 'STORE_COUNTRY';

-- Add iso_numeric and custom1 columns to countries
ALTER TABLE countries ADD iso_numeric VARCHAR(10);
ALTER TABLE countries ADD custom1 NVARCHAR(10);
...
-- New Custom fields:
ALTER TABLE orders ADD custom6 NVARCHAR(16);
ALTER TABLE orders ADD custom7 NVARCHAR(16);
ALTER TABLE orders ADD custom8 NVARCHAR(16);
ALTER TABLE orders ADD custom9 NVARCHAR(16);
ALTER TABLE orders ADD custom10 NVARCHAR(16);

ALTER TABLE orders_products ADD custom6 NVARCHAR(16);
ALTER TABLE orders_products ADD custom7 NVARCHAR(16);
ALTER TABLE orders_products ADD custom8 NVARCHAR(16);
ALTER TABLE orders_products ADD custom9 NVARCHAR(16);
ALTER TABLE orders_products ADD custom10 NVARCHAR(16);

ALTER TABLE customers_basket ADD custom6 NVARCHAR(16);
ALTER TABLE customers_basket ADD custom7 NVARCHAR(16);
ALTER TABLE customers_basket ADD custom8 NVARCHAR(16);
ALTER TABLE customers_basket ADD custom9 NVARCHAR(16);
ALTER TABLE customers_basket ADD custom10 NVARCHAR(16);

-- New logo content type
INSERT INTO kk_content_type (content_type_id, date_added) VALUES (13, getdate());

INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (13, 1, 'Logo', 'Logo Image', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (13, 2, 'Logo', 'Logo Image', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (13, 3, 'Logo', 'Imagen del logotipo', getdate());
INSERT INTO kk_content_type_desc (content_type_id, language_id, content_type_name, description, date_added) VALUES (13, 4, 'Logotipo', 'Imagem do logotipo', getdate());

-- Logo Image
INSERT INTO kk_content (content_id, content_type_id, click_url, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (31, 13, 'Welcome.action', -1, -1, 1, 2, getdate(), getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (31, 1, 'logo.png', '', '', 'KonaKart Logo', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (31, 2, 'logo.png', '', '', 'KonaKart Logo', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (31, 3, 'logo.png', '', '', 'KonaKart Logo', getdate());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (31, 4, 'logo.png', '', '', 'KonaKart Logo', getdate());

-- Configuration variable to enable/disable Content Caching
DELETE FROM configuration WHERE configuration_key = 'CACHE_CONTENT';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Cache Content','CACHE_CONTENT','true','Set to true to Cache KonaKart Content in memory.','11', '28', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Exported Mailing List Directory', 'MAILLISTS_BASE_DIRECTORY', 'C:/KonaKart/mailLists', 'Defines the root directory where the Mailing Lists are exported to', '12', '9', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Email Output Directory', 'EMAIL_OUTPUT_DIRECTORY', 'C:/KonaKart/logs', 'The location where KonaKart will write email output files', '20', '2', getdate(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Add suggested search for catalog','SOLR_ADD_TERM_FOR_CATALOG','false','Adds a suggested search list for each catalog id since the catalog may contain only a subset of products','24', '30', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');

DELETE FROM configuration WHERE configuration_key = 'SOLR_ADD_SPELLING_FOR_CATALOG';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Add spelling suggestions for catalog','SOLR_ADD_SPELLING_FOR_CATALOG','false','Adds spelling suggestions for each catalog id since the catalog may contain only a subset of products','24', '32', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');

DELETE FROM configuration WHERE configuration_key = 'SOLR_CATALOG_USED_FOR_PRICE';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Catalogs used for product prices','SOLR_CATALOG_USED_FOR_PRICE','false','Set to true if catalogs are used to determine product prices','24', '34', 'choice(''true''=''true'',''false''=''false'')', getdate(), '0');

DELETE FROM configuration WHERE configuration_key = 'SOLR_CATALOG_USED_FOR_QTY';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Catalogs used for product quantities','SOLR_CATALOG_USED_FOR_QTY','false','Set to true if catalogs are used to determine product quantities','24', '36', 'choice(''true''=''true'',''false''=''false'')', getdate(), '0');
...
ALTER TABLE orders ADD filter1 NVARCHAR(32);
ALTER TABLE orders ADD filter2 NVARCHAR(32);
...
INSERT INTO address_book (customers_id, entry_gender, entry_company, entry_firstname, entry_lastname, entry_street_address, entry_suburb, entry_postcode, entry_city, entry_state, entry_country_id, entry_zone_id) VALUES (-1, 'm', 'KonaKart Ltd.', 'Order', 'Followup', '4 Way Street', '', 'PostCode4', 'NeverNever', '', 223, 12);
INSERT INTO customers (customers_gender, customers_firstname, customers_lastname,customers_dob, customers_email_address, customers_default_address_id, customers_telephone, customers_fax, customers_password, customers_newsletter, customers_type) VALUES ('m', 'Order', 'Followup', '1977-01-01 00:00:00', 'order.followup@konakart.com', -1, '019084', '', 'f5147fc3f6eb46e234c01db939bdb581:08', '0', 1);
INSERT INTO customers_info SELECT customers_id , getdate(), 0, getdate(), getdate(), 0, 'store1' FROM customers WHERE customers_email_address = 'order.followup@konakart.com' AND customers_telephone='019084';
...
INSERT INTO kk_customers_to_role (role_id, customers_id, date_added) SELECT 3, customers_id, getdate() FROM customers WHERE customers_email_address = 'order.followup@konakart.com' AND customers_telephone='019084';
INSERT INTO kk_customers_to_role (role_id, customers_id, date_added) SELECT 4, customers_id, getdate() FROM customers WHERE customers_email_address = 'order.followup@konakart.com' AND customers_telephone='019084';
...
INSERT INTO kk_filter (user_id, filter_table, filter_column, filter_constraint, date_added, date_updated) SELECT customers_id, 'orders', 'orders_status', 'in (2,4)', getdate(), getdate() FROM customers WHERE customers_email_address = 'order.followup@konakart.com' AND customers_telephone='019084';
...
UPDATE configuration SET configuration_value = 'C:/KonaKart/database/MSSqlServer/konakart_new_store.sql' WHERE configuration_key = 'KK_NEW_STORE_SQL_FILENAME';
UPDATE configuration SET configuration_value = 'C:/KonaKart/database/MSSqlServer/konakart_user_new_store.sql' WHERE configuration_key = 'USER_NEW_STORE_SQL_FILENAME';
...
INSERT INTO prod_opt_vals_to_prod_opt (products_options_id, products_options_values_id) VALUES ( 1, 13);
INSERT INTO prod_opt_vals_to_prod_opt (products_options_id, products_options_values_id) VALUES ( 1, 14);
INSERT INTO prod_opt_vals_to_prod_opt (products_options_id, products_options_values_id) VALUES ( 1, 15);

UPDATE products_options SET code = 'COL' WHERE products_options_id = '1';

-- Add color attributes to Brabantia Bin product
INSERT INTO products_attributes (products_id, options_id, options_values_id, options_values_price, price_prefix, sort_order) VALUES (44,1,13,0.00,'+',1);
INSERT INTO products_attributes (products_id, options_id, options_values_id, options_values_price, price_prefix, sort_order) VALUES (44,1,14,0.00,'+',0);
INSERT INTO products_attributes (products_id, options_id, options_values_id, options_values_price, price_prefix, sort_order) VALUES (44,1,15,0.00,'+',2);
...
INSERT INTO countries ( countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES ('Åland Islands','AX','ALA',1, '248');
INSERT INTO countries ( countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES ('Guernsey','GG','GGY',1, '831');
INSERT INTO countries ( countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES ('Montenegro','ME','MNE',1, '499');
INSERT INTO countries ( countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES ('Palestine','PS','PSE',1, '275');
INSERT INTO countries ( countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES ('Saint Barthélemy','BL','BLM',1, '652');
INSERT INTO countries ( countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES ('Saint Helena, Ascension and Tristan da Cunha','SH','SHN',1, '654');
INSERT INTO countries ( countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES ('Saint Martin (French part)','MF','MAF',1, '663');
INSERT INTO countries ( countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES ('Saint Pierre and Miquelon','PM','SPM',1, '666');
INSERT INTO countries ( countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES ('Sint Maarten (Dutch part)','SX','SXM',1, '534');
INSERT INTO countries ( countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES ('South Sudan','SS','SSD',1, '728');
INSERT INTO countries ( countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, iso_numeric) VALUES ('Timor-Leste','TL','TLS',1, '626');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Enable stock reservation','STOCK_RESERVATION_ENABLE','false','Set to true if you want to reserve stock during checkout','9', '40', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');

-- Defines global stock reservation time
DELETE FROM configuration WHERE configuration_key = 'STOCK_RESERVATION_TIME_SECS';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Stock Reservation time in secs','STOCK_RESERVATION_TIME_SECS','0','Number of seconds stock will be reserved for','9', '45', 'integer(0,null)', getdate(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Allow Checkout When Stock Not Available','STORE_FRONT_STOCK_ALLOW_CHECKOUT','true','When true, the storefront allows checkout even when stock is not available','9', '2', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
...
-- New API calls
INSERT INTO kk_api_call (name, description, date_added) VALUES ('addChildrenToCustomer', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getCustomerForEmailWithOptions', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getCustomerForIdWithOptions', '', getdate());

--B2B Customer tag examples
DELETE FROM kk_customer_tag WHERE name ='B2B_CAN_CHANGE_ADDRESS';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_CAN_CHANGE_ADDRESS', 'Customer can modify / add the destination addresses of an order', 'true|false', 5, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='B2B_CAN_APPROVE_ORDERS';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_CAN_APPROVE_ORDERS', 'Customer can approve orders of child customers', 'true|false', 5, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='B2B_VIEW_PARENT_ORDERS';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_VIEW_PARENT_ORDERS', 'Customer can view orders of parent customer', 'true|false', 5, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='B2B_VIEW_CHILD_ORDERS';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_VIEW_CHILD_ORDERS', 'Customer can view orders of child customers', 'true|false', 5, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='B2B_VIEW_SIBLING_ORDERS';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_VIEW_SIBLING_ORDERS', 'Customer can view orders of sibling customers', 'true|false', 5, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='B2B_ORDERS_NEED_APPROVAL';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_ORDERS_NEED_APPROVAL', 'Order needs to be approved by a parent customer', 'true|false', 5, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='B2B_ORDER_LIMIT';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_ORDER_LIMIT', 'Maximum order value that can be submitted by this customer', '', 3, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='B2B_CATALOG_KEY';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_CATALOG_KEY', 'Catalog Key used for this customer', '', 0, 1, getdate());
...
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (11,(SELECT languages_id FROM languages WHERE code = 'en'),'Waiting for Approval');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (11,(SELECT languages_id FROM languages WHERE code = 'de'),'Warten auf die Bestätigung');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (11,(SELECT languages_id FROM languages WHERE code = 'es'),'A la espera de la aprobación');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (11,(SELECT languages_id FROM languages WHERE code = 'pt'),'Esperando aprovação');

-- New order state - Approved
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (12,(SELECT languages_id FROM languages WHERE code = 'en'),'Approved');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (12,(SELECT languages_id FROM languages WHERE code = 'de'),'Genehmigt');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (12,(SELECT languages_id FROM languages WHERE code = 'es'),'Aprobado');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (12,(SELECT languages_id FROM languages WHERE code = 'pt'),'Aprovado');

-- New order state - Approval Declined
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (13,(SELECT languages_id FROM languages WHERE code = 'en'),'Approval Declined');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (13,(SELECT languages_id FROM languages WHERE code = 'de'),'Approval Abgelehnt');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (13,(SELECT languages_id FROM languages WHERE code = 'es'),'Se rechaza la aprobación');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (13,(SELECT languages_id FROM languages WHERE code = 'pt'),'Aprovação Recusado');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Name format template', 'NAME_FORMAT_TEMPLATE', '$firstname $lastname', 'The default template used for formatting a customer name', '5', '20', getdate(), '1');

------------------------------------------------------------------
-- ERP XML Interface

INSERT INTO configuration_group VALUES ( 'User Defined', 'User Defined Configuration', 31, 1, null);
INSERT INTO configuration_group VALUES ( 'ERP Integration', 'ERP Integration Configuration', 32, 1, null);

-- Configuration variable for log directories
DELETE FROM configuration where configuration_key = 'ERP_INT_LOG_BASE_PATH_OK';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order,  date_added, return_by_api, store_id) SELECT 'Msg Log Directory Good', 'ERP_INT_LOG_BASE_PATH_OK', configuration_value +  '/mq_logs/success', 'Defines the directory where the log file is written for messages that are processed correctly', '32', '12', getdate(), '1', store_id FROM configuration WHERE configuration_key = 'INSTALLATION_HOME';

DELETE FROM configuration where configuration_key = 'ERP_INT_INTEGRATION_ENABLED';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api, store_id) SELECT 'ERP Integration Enabled?', 'ERP_INT_INTEGRATION_ENABLED', configuration_value +  'false', 'Set to true to enable ERP Integration', '32', '5', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1', store_id FROM configuration WHERE configuration_key = 'INSTALLATION_HOME';

DELETE FROM configuration where configuration_key = 'ERP_INT_LOG_BASE_PATH_KO';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order,  date_added, return_by_api, store_id) SELECT 'Msg Log Directory Failed', 'ERP_INT_LOG_BASE_PATH_KO', configuration_value +  '/mq_logs/failure', 'Defines the directory where the log file is written for messages that cannot be processed', '32', '20', getdate(), '1', store_id FROM configuration WHERE configuration_key = 'INSTALLATION_HOME';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order,  date_added, return_by_api) VALUES ('Email Address for Failed messages', 'ERP_INT_LOG_KO_EMAIL_ADDR', 'admin@konakart.com', 'Defines the email address where logs are sent when a message fails', '32', '30', getdate(), '1');

DELETE FROM configuration where configuration_key = 'ERP_INT_LOG_KO_EMAIL_TEMPLATE';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order,  date_added, return_by_api) VALUES ('Template for failed msg email', 'ERP_INT_LOG_KO_EMAIL_TEMPLATE', 'ERPIntegrationErrorNotification_en.vm', 'The velocity email template for failed messages. Template name includes country code.', '32', '31', getdate(), '1');

-- Configuration variable for ERP Invoice directory
DELETE FROM configuration where configuration_key = 'ERP_INT_INVOICE_PATH';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order,  date_added, return_by_api) VALUES ('ERP Invoice Path', 'ERP_INT_INVOICE_PATH', '', 'Defines the directory where the ERP invoices can be found. Ignored if the path is included in the message', '32', '40', getdate(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order,  date_added, return_by_api) VALUES ('ERP Invoice template', 'ERP_INT_INVOICE_EMAIL_TEMPLATE', 'ERPIntegrationOrderInvoice_en.vm', 'Defines the velocity template for the email sent to the customer. Ignored if the template is included in the message. Country code is determined from the locale of the order if left out.', '32', '50', getdate(), '1');

-- New Admin App Panel for ERP Integration Configuration
INSERT INTO kk_panel (code, description, date_added) VALUES ('kk_panel_erpConfig','ERP Integration Configuration', getdate());

-- Add ERP Integration Config Panel access to all roles that can access the 'kk_panel_storeConfiguration' panel
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, p2.panel_id, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p, kk_panel p2 where rtp.panel_id=p.panel_id and p.code='kk_panel_storeConfiguration' and p2.code='kk_panel_erpConfig';

-- Password expiry
ALTER TABLE customers ADD password_change smallint DEFAULT '0' NOT NULL;
ALTER TABLE customers ADD password_expiry datetime;
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Valid time (mins) for temp password', 'TEMP_PASSWORD_VALID_TIME_MINS', '30', 'Defines the number of minutes a temporary password sent out in an email is valid for', '18', '20', 'integer(null,null)', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Status Ids of orders to display','ORDER_DISPLAY_STATUS_IDS','','Comma separated list of order status ids that will be displayed to customers. All orders displayed if empty.','9', '50', getdate(), '1');

-- Add some new indexes for improved read performance
CREATE INDEX i_products_id_specials ON specials (products_id);
CREATE INDEX i_configuration_key_configuration ON configuration (configuration_key);
CREATE INDEX i_customers_id_kk_customers_to_tag ON kk_customers_to_tag (customers_id);
...
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (14,(SELECT languages_id FROM languages WHERE code = 'en'),'Archived');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (14,(SELECT languages_id FROM languages WHERE code = 'de'),'Archivierte');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (14,(SELECT languages_id FROM languages WHERE code = 'es'),'Archivado');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (14,(SELECT languages_id FROM languages WHERE code = 'pt'),'Arquivado');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Status Ids of orders to not display','ORDER_DISPLAY_EXCLUDE_STATUS_IDS','14','Comma separated list of order status ids that will not be displayed to customers. All orders displayed if empty.','9', '55', getdate(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Allow admin to edit customer order','ALLOW_EDIT_ORDER','false','When true, an administrator logging in as a customer can edit a customer order','1', '45', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Allow admin to discount customer order','ALLOW_ADMIN_ORDER_DISCOUNT','false','When true, an administrator logging in as a customer can add a discount to a customer order','1', '50', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');

-- Allow NULLs in tag_value
ALTER TABLE kk_expression_variable ALTER COLUMN tag_value NVARCHAR(255) NULL;
...
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('HISTORY', '8.5.0.0 I', getdate());
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('VERSION', '8.5.0.0 SQLServer', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Update product viewed count','UPDATE_PRODUCT_VIEWED_COUNT','false','When true, the product viewed count is incremented every time a product is viewed',1, 55, 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');

-- Add reservation_id to kk_reserved_stock
ALTER TABLE kk_reserved_stock ADD reservation_id int DEFAULT 0 NOT NULL;
CREATE INDEX i_reservation_id_kk_reserved_stock ON kk_reserved_stock (reservation_id);

-- For specifying whether or not customer tags can be set using KKEngIf API calls
ALTER TABLE kk_customer_tag ADD set_by_api smallint NOT NULL DEFAULT 0;
...
-- New API call
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteProdAttrDescWithOptions', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteProducts', '', getdate());

--Promotion tester customer tag
DELETE FROM kk_customer_tag WHERE name ='PROMOTION_TESTER';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('PROMOTION_TESTER', 'Promotion Tester', 'true|false', 5, 1, getdate());

--Promotion tester expression
DELETE FROM kk_expression WHERE name ='PromotionTester';
INSERT INTO kk_expression (name, description, num_variables, date_added) VALUES ('PromotionTester', 'Determines whether user is a promotion tester',1,getdate());
...
INSERT INTO kk_expression_variable (kk_customer_tag_id, kk_expression_id, tag_type, tag_value, date_added) VALUES ((select kk_customer_tag_id from kk_customer_tag where name ='PROMOTION_TESTER'),(select kk_expression_id from kk_expression where name ='PromotionTester'),5,'true',getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Promotion Tester Expression', 'PROMOTION_TESTER_EXPRESSION', 'PromotionTester', 'The expression used for determining promotion testers', '5', '25', getdate(), '1');

DROP TABLE kk_credit_card;
CREATE TABLE kk_credit_card (
  kk_credit_card_id int NOT NULL identity(1,1),
  store_id varchar(64),
  customers_id int NOT NULL,
  address_id int,
  ccType varchar(32),
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('TZ DB Time Zone', 'TZ_DB_TIME_ZONE', '', 'The tz database time zone for the store. e.g. US/Pacific', '1', '7', getdate(), '1');

-- New API call
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getStoreTime', '', getdate());

-- B2B Customer tags for monthly order limit
DELETE FROM kk_customer_tag WHERE name ='B2B_AGGREGATE_ORDER_LIMIT';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_AGGREGATE_ORDER_LIMIT', 'Maximum total order value that can be submitted in a period of time', '', 3, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='B2B_AGGREGATE_ORDER_TOTAL';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('B2B_AGGREGATE_ORDER_TOTAL', 'The current order value total for a period of time', '', 3, 1, getdate());

-- Admin Caches
DELETE FROM configuration WHERE configuration_key = 'ADMIN_CONFIG_CACHE_CHECK_SECS';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Admin caches refresh check interval', 'ADMIN_CONFIG_CACHE_CHECK_SECS', '30', 'Interval in seconds for checking to see whether to refresh the KonaKartAdmin caches', '11', '10', getdate(), '1');

DELETE FROM configuration WHERE configuration_key = 'ADMIN_CONFIG_CACHE_CHECK_FLAG';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Admin caches refresh flag','ADMIN_CONFIG_CACHE_CHECK_FLAG','false','Boolean to determine whether to refresh the admin config caches','100','1', getdate(), '1');
