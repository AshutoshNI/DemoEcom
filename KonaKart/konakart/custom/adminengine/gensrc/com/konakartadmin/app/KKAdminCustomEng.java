...
public class KKAdminCustomEng implements com.konakartadmin.appif.KKAdminIf
{
     ...
     */
     ...
     private GetCustomerForIdWithOptions _getCustomerForIdWithOptions = null;
     ...
     private DeleteProducts _deleteProducts = null;
     ...
     private DeletePromotionWithOptions _deletePromotionWithOptions = null;
     ...
     private AddRelatedProductsWithOptions _addRelatedProductsWithOptions = null;
     ...
     private GetCustomerForEmailWithOptions _getCustomerForEmailWithOptions = null;
     ...
     private DeleteProdAttrDescWithOptions _deleteProdAttrDescWithOptions = null;
     ...
     private InsertContent _insertContent = null;
     private DeleteContent _deleteContent = null;
     private UpdateContent _updateContent = null;
     private GetContentTypes _getContentTypes = null;
     private GetContentType _getContentType = null;
     private InsertContentType _insertContentType = null;
     private DeleteContentType _deleteContentType = null;
     private UpdateContentType _updateContentType = null;
     private GetCouponCode _getCouponCode = null;
     private CreateMailingList _createMailingList = null;
     private AddCatalogRules _addCatalogRules = null;
     private GetCatalogRules _getCatalogRules = null;
     private CreateCatalogPricesFromRules _createCatalogPricesFromRules = null;
     private GetFilters _getFilters = null;
     private GetFiltersForCustomer _getFiltersForCustomer = null;
     private GetFilter _getFilter = null;
     private InsertFilter _insertFilter = null;
     private UpdateFilter _updateFilter = null;
     private DeleteFilter _deleteFilter = null;
     private DeleteFiltersForCustomer _deleteFiltersForCustomer = null;
     private AddChildrenToCustomer _addChildrenToCustomer = null;
     private GetStoreTime _getStoreTime = null;
...
protected KKAdminException manageThrowable(Throwable e)
{
     ...
     * @param propertyName
     *            property name
     * @return Returns the value of the specified property as a String. If the property key isn't
     ...
     *            currencies are returned ordered by the currency title.
     * @return Returns an AdminLanguageSearchResult
     * @throws KKAdminException
     */
    ...
    /**
     * Returns a set of Orders that match the search criteria. If <code>fillOrderProducts</code> is
     ...
     *            children when implementing a hierarchical customer structure.
     * @return Customer Object or Null if the customer doesn't exist.
     * @throws KKAdminException
     */
     public AdminCustomer getCustomerForIdWithOptions(String sessionId, int customerId, AdminGetCustomerOptions options) throws KKAdminException
     {
         try
         {
            if (_getCustomerForIdWithOptions == null)
            {
                _getCustomerForIdWithOptions = new GetCustomerForIdWithOptions(kkAdminEng);
            }

            return _getCustomerForIdWithOptions.getCustomerForIdWithOptions(sessionId, customerId, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public void deleteProducts(String sessionId, AdminCommonOptions options) throws KKAdminException
     {
         try
         {
            if (_deleteProducts == null)
            {
                _deleteProducts = new DeleteProducts(kkAdminEng);
            }

            _deleteProducts.deleteProducts(sessionId, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * manufacturers, categories, products, coupons and other objects are also deleted.
     * 
     * @param sessionId
     *            The session id of the logged in user
     * @param promotionId
    ...
    /**
     * Delete the promotion referenced by promotionId. All of the relationships that the promotion
     * may have with customers, manufacturers, categories, products, coupons and other objects are
     * also deleted.<br>
     * The options parameter allows you to decide whether to delete associated coupons and whether
     * to perform a check to determine whether they are being used by any other promotion before
     * deletion. If this check isn't performed, the delete process is a lot faster.
     * 
     * @param sessionId
     *            The session id of the logged in user
     * @param promotionId
     ...
     *            determine whether they are being used by any other promotion before deletion.
     * @throws KKAdminException
     */
     public void deletePromotionWithOptions(String sessionId, int promotionId, AdminDeletePromotionOptions options) throws KKAdminException
     {
         try
         {
            if (_deletePromotionWithOptions == null)
            {
                _deletePromotionWithOptions = new DeletePromotionWithOptions(kkAdminEng);
            }

            _deletePromotionWithOptions.deletePromotionWithOptions(sessionId, promotionId, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * <p>
     * In order to not modify the <code>timesUsed</code> attribute of the promotion, it must be set
     * to -1.
     * 
     * @param sessionId
     *            The session id of the logged in user
     ...
     * attributes - <code>relationCustom1</code> and <code>relationCustom2</code> which if set, will
     ...
     */
     public void addRelatedProductsWithOptions(String sessionId, AdminProduct[] products, int productId, int relationType, AdminProductMgrOptions mgrOptions) throws KKAdminException
     {
         try
         {
            if (_addRelatedProductsWithOptions == null)
            {
                _addRelatedProductsWithOptions = new AddRelatedProductsWithOptions(kkAdminEng);
            }

            _addRelatedProductsWithOptions.addRelatedProductsWithOptions(sessionId, products, productId, relationType, mgrOptions);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public AdminCustomer getCustomerForEmailWithOptions(String sessionId, String emailAddress, AdminGetCustomerOptions options) throws KKAdminException
     {
         try
         {
            if (_getCustomerForEmailWithOptions == null)
            {
                _getCustomerForEmailWithOptions = new GetCustomerForEmailWithOptions(kkAdminEng);
            }

            return _getCustomerForEmailWithOptions.getCustomerForEmailWithOptions(sessionId, emailAddress, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     *            array) and the name with the storeId (or leave null for all stores).
     ...
     *            deleted attribute from the products using it.
     * @return Returns the id of the deleted AdminProdAttrDesc object
     * @throws KKAdminException
     */
     public int deleteProdAttrDescWithOptions(String sessionId, int id, AdminProdAttrDescOptions options) throws KKAdminException
     {
         try
         {
            if (_deleteProdAttrDescWithOptions == null)
            {
                _deleteProdAttrDescWithOptions = new DeleteProdAttrDescWithOptions(kkAdminEng);
            }

            return _deleteProdAttrDescWithOptions.deleteProdAttrDescWithOptions(sessionId, id, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Scale the specified image to the specified name and dimensions. Supported image extensions
     ...
     *            The session id of the logged in user
     * @param search
     * @return Returns an AdminShipperSearchResult object
     * @throws KKAdminException
     */
    ...
    /**
     * Returns an array of content records matching the search criteria. If no records are found an
     * empty array is returned.
     * 
     * @param sessionId
     *            Session Id of the user.
     * @param search
     *            an AdminContentSearch object
     * @param dataDesc
     *            an AdminDataDescriptor object
     * @return Returns an AdminContentSearchResult object containing an array of content records
     *         matching the search criteria. If there are no records an empty array is returned
     *         within the AdminContentSearchResult.
     * @throws KKAdminException
     */
     public AdminContentSearchResult getContents(String sessionId, AdminContentSearch search, AdminDataDescriptor dataDesc) throws KKAdminException
     {
         try
         {
            ...
            {
                _getContents = new GetContents(kkAdminEng);
            }

            return _getContents.getContents(sessionId, search, dataDesc);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * @return Returns an AdminContent object if it exists, otherwise it returns null
     * @throws KKAdminException
     */
     public AdminContent getContent(String sessionId, int contentId) throws KKAdminException
     {
         try
         {
            if (_getContent == null)
            {
                _getContent = new GetContent(kkAdminEng);
            }

            return _getContent.getContent(sessionId, contentId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Insert an AdminContent object. If the contentId attribute is not equal to 0 or -1 it is
     * inserted otherwise it is updated with the id of the newly-inserted AdminContent object.
     * 
     * @param sessionId
     *            Session Id of the user.
     * @param content
     *            an AdminContent object
     * @return returns the id of the inserted AdminContent
     * @throws KKAdminException
     */
     public int insertContent(String sessionId, AdminContent content) throws KKAdminException
     {
         try
         {
            if (_insertContent == null)
            {
                _insertContent = new InsertContent(kkAdminEng);
            }

            return _insertContent.insertContent(sessionId, content);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     *            Session Id of the user.
     * @param contentId
     *            the contentId of the AdminContent record to delete
     * @throws KKAdminException
     */
     public void deleteContent(String sessionId, int contentId) throws KKAdminException
     {
         try
         {
            ...
            {
                _deleteContent = new DeleteContent(kkAdminEng);
            }

            _deleteContent.deleteContent(sessionId, contentId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public void updateContent(String sessionId, AdminContent content) throws KKAdminException
     {
         try
         {
            if (_updateContent == null)
            {
                _updateContent = new UpdateContent(kkAdminEng);
            }

            _updateContent.updateContent(sessionId, content);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Returns an array of AdminContentType records matching the search criteria. If no records are
     * found an empty array is returned.
     * 
     * @param sessionId
     *            Session Id of the user.
     * @param search
     *            an AdminContentTypeSearch object
     * @param dataDesc
     ...
     *            <li>AdminDataDescriptor.ORDER_BY_CUSTOM1_DESCENDING</li>
     *            </ul>
     * @return Returns an AdminContentSearchTypeResult object containing an array of content type
     *         records matching the search criteria. If there are no records an empty array is
     *         returned within the AdminContentTypeSearchResult.
     * @throws KKAdminException
     */
     public AdminContentTypeSearchResult getContentTypes(String sessionId, AdminContentTypeSearch search, AdminDataDescriptor dataDesc) throws KKAdminException
     {
         try
         {
            ...
            {
                _getContentTypes = new GetContentTypes(kkAdminEng);
            }

            return _getContentTypes.getContentTypes(sessionId, search, dataDesc);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * @return Returns an AdminContentType object if it exists, otherwise it returns null
     * @throws KKAdminException
     */
     public AdminContentType getContentType(String sessionId, int contentTypeId) throws KKAdminException
     {
         try
         {
            ...
            {
                _getContentType = new GetContentType(kkAdminEng);
            }

            return _getContentType.getContentType(sessionId, contentTypeId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Insert an AdminContentType object. If the contentTypeId attribute is not equal to 0 or -1 it
     * is inserted otherwise it is updated with the id of the newly-inserted AdminContentType
     * object.
     * 
     * @param sessionId
     *            Session Id of the user.
     * @param contentType
     *            an AdminContentType object
     * @return returns the id of the inserted AdminContentType
     * @throws KKAdminException
     */
     public int insertContentType(String sessionId, AdminContentType contentType) throws KKAdminException
     {
         try
         {
            if (_insertContentType == null)
            {
                _insertContentType = new InsertContentType(kkAdminEng);
            }

            return _insertContentType.insertContentType(sessionId, contentType);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     *            Session Id of the user.
     * @param contentTypeId
     *            the contentTypeId of the AdminContentType record to delete
     * @throws KKAdminException
     */
     public void deleteContentType(String sessionId, int contentTypeId) throws KKAdminException
     {
         try
         {
            if (_deleteContentType == null)
            {
                _deleteContentType = new DeleteContentType(kkAdminEng);
            }

            _deleteContentType.deleteContentType(sessionId, contentTypeId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public void updateContentType(String sessionId, AdminContentType content) throws KKAdminException
     {
         try
         {
            if (_updateContentType == null)
            {
                _updateContentType = new UpdateContentType(kkAdminEng);
            }

            _updateContentType.updateContentType(sessionId, content);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     *            Session Id of the user.
     * @param options
     *            Optional parameter that may be used to control how the coupon code is generated
     * @return Returns a coupon code
     * @throws KKAdminException
     */
     public String getCouponCode(String sessionId, String options) throws KKAdminException
     {
         try
         {
            if (_getCouponCode == null)
            {
                _getCouponCode = new GetCouponCode(kkAdminEng);
            }

            return _getCouponCode.getCouponCode(sessionId, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public void createMailingList(String sessionId, AdminCustomerSearch search, AdminMailListOptions listOptions) throws KKAdminException
     {
         try
         {
            if (_createMailingList == null)
            {
                _createMailingList = new CreateMailingList(kkAdminEng);
            }

            _createMailingList.createMailingList(sessionId, search, listOptions);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * automatically using <code>createCatalogPricesFromRules()</code> using the rules to make price
     ...
     * <ul>
     * <li>Include or exclude products from that category and all subcategories</li>
     * <li>Make a percentage price adjustment (up or down) for all products in the category and
     * subcategories</li>
     * <li>Add a fixed price for all products in the category and subcategories</li>
     * </ul>
     * If a product is in more than one category then we determine whether one of the categories is
     * invisible and use the price rules from that category. This allows an administrator to include
     * special cases for individual products by placing them in invisible categories.
     * 
     * @param sessionId
     *            Session Id of the user.
     * @param catalogId
     *            The alphanumeric catalog identifier to which the rules apply
     * @param rules
     *            An array of rules
     * @throws KKAdminException
     */
     public void addCatalogRules(String sessionId, String catalogId, AdminCatalogRule[] rules) throws KKAdminException
     {
         try
         {
            if (_addCatalogRules == null)
            {
                _addCatalogRules = new AddCatalogRules(kkAdminEng);
            }

            _addCatalogRules.addCatalogRules(sessionId, catalogId, rules);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * <code>createCatalogPricesFromRules()</code> to automatically create the catalog using the
     ...
     * @return Returns an array of catalog rules sorted by category id ascending
     * @throws KKAdminException
     */
     public AdminCatalogRule[] getCatalogRules(String sessionId, String catalogId) throws KKAdminException
     {
         try
         {
            if (_getCatalogRules == null)
            {
                _getCatalogRules = new GetCatalogRules(kkAdminEng);
            }

            return _getCatalogRules.getCatalogRules(sessionId, catalogId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * added using the <code>addCatalogRules()</code> method. The rules are used to make price
     * adjustments to products within selected categories and to include or exclude products from
     * selected categories.
     * 
     * @param sessionId
     ...
     *            <ul>
     *            <li>
     *            All products are read from the database in a loop to add to the catalog. You can
     *            define the maximum number of records read at a time. It can be changed for
     *            performance reasons based on the specs of your system and number of products in
     *            your database.</li>
     *            <li>When running the Solr search engine you can force a reload of the products
     *            once the new prices have been generated.</li>
     *            <li>In some cases it's convenient to create prices dynamically when a user logs
     *            into the system. The options object allows you to specify a time period so that
     *            new prices are only created if that time period has elapsed since the last
     *            creation time.</li>
     *            </ul>
     * @return Returns an object containing the number of products added to the catalog and the id
     *         of the catalog
     * @throws KKAdminException
     */
     public AdminCreateCatalogPricesResult createCatalogPricesFromRules(String sessionId, String catalogId, AdminCreateCatalogPriceOptions options) throws KKAdminException
     {
         try
         {
            if (_createCatalogPricesFromRules == null)
            {
                _createCatalogPricesFromRules = new CreateCatalogPricesFromRules(kkAdminEng);
            }

            return _createCatalogPricesFromRules.createCatalogPricesFromRules(sessionId, catalogId, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Returns an array of filter records matching the search criteria. If no records are found an
     * empty array is returned.
     * 
     * @param sessionId
     *            Session Id of the user.
     * @param search
     *            an AdminFilterSearch object
     * @param dataDesc
     *            an AdminDataDescriptor object
     *            <p>
     ...
     *            <li>AdminDataDescriptor.ORDER_BY_CUSTOMERS_ID_ASCENDING</li>
     *            <li>AdminDataDescriptor.ORDER_BY_CUSTOMERS_ID_ASCENDING</li>
     *            <li>AdminDataDescriptor.ORDER_BY_TABLE_ASCENDING</li>
     *            <li>AdminDataDescriptor.ORDER_BY_TABLE_DESCENDING</li>
     *            <li>AdminDataDescriptor.ORDER_BY_COLUMN_ASCENDING</li>
     *            <li>AdminDataDescriptor.ORDER_BY_COLUMN_DESCENDING</li>
     *            <li>AdminDataDescriptor.ORDER_BY_CONSTRAINT_ASCENDING</li>
     *            <li>AdminDataDescriptor.ORDER_BY_CONSTRAINT_DESCENDING</li>
     *            <li>AdminDataDescriptor.ORDER_BY_CUSTOM1_ASCENDING</li>
     *            <li>AdminDataDescriptor.ORDER_BY_CUSTOM1_DESCENDING</li>
     *            <li>AdminDataDescriptor.ORDER_BY_CUSTOM2_ASCENDING</li>
     *            <li>AdminDataDescriptor.ORDER_BY_CUSTOM3_DESCENDING</li>
     *            </ul>
     * @return Returns an AdminFilterSearchResult object containing an array of filter records
     *         matching the search criteria. If there are no records an empty array is returned
     *         within the AdminFilterSearchResult.
     * @throws KKAdminException
     */
     public AdminFilterSearchResult getFilters(String sessionId, AdminFilterSearch search, AdminDataDescriptor dataDesc) throws KKAdminException
     {
         try
         {
            if (_getFilters == null)
            {
                _getFilters = new GetFilters(kkAdminEng);
            }

            return _getFilters.getFilters(sessionId, search, dataDesc);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * @param custId
     *            an AdminFilterSearch object
     * @return Returns the filters belonging to the specified customer. If there are no records an
     *         empty array is returned.
     * @throws KKAdminException
     */
     public AdminFilter[] getFiltersForCustomer(String sessionId, int custId) throws KKAdminException
     {
         try
         {
            if (_getFiltersForCustomer == null)
            {
                _getFiltersForCustomer = new GetFiltersForCustomer(kkAdminEng);
            }

            return _getFiltersForCustomer.getFiltersForCustomer(sessionId, custId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * @return Returns an AdminFilter object if it exists, otherwise it returns null
     * @throws KKAdminException
     */
     public AdminFilter getFilter(String sessionId, int Id) throws KKAdminException
     {
         try
         {
            if (_getFilter == null)
            {
                _getFilter = new GetFilter(kkAdminEng);
            }

            return _getFilter.getFilter(sessionId, Id);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     *            Session Id of the user.
     * @param filter
     *            the AdminFilter record to insert
     * @return the Id of the inserted AdminFilter
     * @throws KKAdminException
     */
     public int insertFilter(String sessionId, AdminFilter filter) throws KKAdminException
     {
         try
         {
            ...
            {
                _insertFilter = new InsertFilter(kkAdminEng);
            }

            return _insertFilter.insertFilter(sessionId, filter);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public void updateFilter(String sessionId, AdminFilter filter) throws KKAdminException
     {
         try
         {
            ...
            {
                _updateFilter = new UpdateFilter(kkAdminEng);
            }

            _updateFilter.updateFilter(sessionId, filter);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     *            Session Id of the user.
     * @param id
     *            the Id of the AdminFilter record to delete
     * @throws KKAdminException
     */
     public void deleteFilter(String sessionId, int id) throws KKAdminException
     {
         try
         {
            if (_deleteFilter == null)
            {
                _deleteFilter = new DeleteFilter(kkAdminEng);
            }

            _deleteFilter.deleteFilter(sessionId, id);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     *            Session Id of the user.
     * @param userId
     *            the userId of the customer whose AdminFilter records to delete
     * @throws KKAdminException
     */
     public void deleteFiltersForCustomer(String sessionId, int userId) throws KKAdminException
     {
         try
         {
            if (_deleteFiltersForCustomer == null)
            {
                _deleteFiltersForCustomer = new DeleteFiltersForCustomer(kkAdminEng);
            }

            _deleteFiltersForCustomer.deleteFiltersForCustomer(sessionId, userId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * Any existing child of the parent that isn't in the array, is deleted. Only the id of the
     * children objects needs to be populated.
     * 
     * @param sessionId
     *            Session Id of the user.
     * @param parentId
     *            ParentId set on the AdminCustomer children objects passed in as a parameter
     * @param children
     *            An array of AdminCustomer objects
     * @throws KKAdminException
     */
     public void addChildrenToCustomer(String sessionId, int parentId, AdminCustomer[] children) throws KKAdminException
     {
         try
         {
            if (_addChildrenToCustomer == null)
            {
                _addChildrenToCustomer = new AddChildrenToCustomer(kkAdminEng);
            }

            _addChildrenToCustomer.addChildrenToCustomer(sessionId, parentId, children);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Returns the local store time based on the tz database time zone of the store. A list can be
     * found here: https://en.wikipedia.org/wiki/List_of_tz_database_time_zones . They are in a
     * string format and look like US/Pacific, Australia/Perth, Europe/London etc. and observe DST.
     * 
     * @return Returns a Calendar object for the current store time
     * @throws KKAdminException
     */
     public Calendar getStoreTime() throws KKAdminException
     {
         try
         {
            if (_getStoreTime == null)
            {
                _getStoreTime = new GetStoreTime(kkAdminEng);
            }

            return _getStoreTime.getStoreTime();
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
