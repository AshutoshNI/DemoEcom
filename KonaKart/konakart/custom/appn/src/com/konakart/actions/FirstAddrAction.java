 ...
 */
public class FirstAddrAction extends BaseAction
{
    ...
    /**
     * Called when we want to proceed to checkout after inserting an address
     * 
    ...
    public String execute()
    {
        ...
        try
        {
            ...
            kkAppEng.getNav().add(kkAppEng.getMsg("header.first.address"), request);
