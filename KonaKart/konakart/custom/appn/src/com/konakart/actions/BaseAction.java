...

{
     ...
     * @throws KKAppException
     */
    protected LoginResultIf login(KKAppEng kkAppEng, HttpServletRequest request, String emailAddr,
            String password) throws KKException, KKAppException
    {
        ...
        LoginResultIf ret = kkAppEng.getCustomerMgr().login(emailAddr, password);
        return ret;
    }
