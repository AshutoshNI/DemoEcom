...
public class KKCustomEng implements com.konakart.appif.KKEngIf
{
     ...
     */
     ...
     private LoginWithOptions _loginWithOptions = null;
     ...
     private GetCustomerWithOptions _getCustomerWithOptions = null;
     ...
     private GetOrdersPerCustomerWithOptions _getOrdersPerCustomerWithOptions = null;
     private SearchForOrdersPerCustomer _searchForOrdersPerCustomer = null;
     private GetOrder _getOrder = null;
     private GetOrderWithOptions _getOrderWithOptions = null;
     ...
     private SaveOrderWithOptions _saveOrderWithOptions = null;
     ...
     private GetCatalogPerKey _getCatalogPerKey = null;
     private SetNewPassword _setNewPassword = null;
     private AddCreditCardToCustomer _addCreditCardToCustomer = null;
     private GetCreditCardsPerCustomer _getCreditCardsPerCustomer = null;
     private DeleteCreditCard _deleteCreditCard = null;
     private EditCreditCard _editCreditCard = null;
    ...
    */
    ...
    /**
     * Returns a LoginResult object containing the result of the login. It returns more information
     * than the login() API call as to why the login may have failed and whether the password needs
     * to be changed.
     * <p>
     * When successful, the LoginResult contains the session key.
     * 
     * @param input
     *            LoginInput object containing the username and password
     * @return Returns a LoginResult object containing the result of the login.
     * @throws KKException
     */
     public LoginResultIf loginWithOptions(LoginInputIf input) throws KKException
     {
         try
         {
            if (_loginWithOptions == null)
            {
                _loginWithOptions = new LoginWithOptions(kkEng);
            }

            return _loginWithOptions.loginWithOptions(input);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public CustomerIf getCustomerWithOptions(String sessionId, FetchCustomerOptionsIf options) throws KKException
     {
         try
         {
            if (_getCustomerWithOptions == null)
            {
                _getCustomerWithOptions = new GetCustomerWithOptions(kkEng);
            }

            return _getCustomerWithOptions.getCustomerWithOptions(sessionId, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * within the hierarchy of the customer referenced by the sessionId.
     * 
     * @param dataDesc
     *            Used to control the data offset, limit the number of items returned and set the
     *            sort order
     ...
     */
     public OrdersIf getOrdersPerCustomerWithOptions(DataDescriptorIf dataDesc, String sessionId, int languageId, FetchOrderOptionsIf options) throws KKException
     {
         try
         {
            if (_getOrdersPerCustomerWithOptions == null)
            {
                _getOrdersPerCustomerWithOptions = new GetOrdersPerCustomerWithOptions(kkEng);
            }

            return _getOrdersPerCustomerWithOptions.getOrdersPerCustomerWithOptions(dataDesc, sessionId, languageId, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Gets on order with the specified order Id, for the customer referenced by the
     * <code>sessionId</code>. Options object allows you to define whether the order may be an order
     ...
     *            to specify whether the <code>archiveOrders</code> attribute should be populated.
     * @return An order object
     * @throws KKException
     */
     public OrderIf getOrderWithOptions(String sessionId, int orderId, int languageId, FetchOrderOptionsIf options) throws KKException
     {
         try
         {
            if (_getOrderWithOptions == null)
            {
                _getOrderWithOptions = new GetOrderWithOptions(kkEng);
            }

            return _getOrderWithOptions.getOrderWithOptions(sessionId, orderId, languageId, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * transaction.
     * <p>
     * The options object allows you to define the id of the order to be archived which is the id of
     * an order that this order is replacing. Both orders will be given the same archiveId. Note
     * that the state of the order to be archived is not changed automatically. You should call
     * updateOrder() to place it in the OrderMgr.ARCHIVED_STATUS state.
     * 
     * @param sessionId
     *            The session id of the logged in user
     * @param order
     ...
     *            language.
     * @param options
     *            Options object allowing you to specify the id of the order to be archived
     * @return Returns the order id
     * @throws KKException
     */
     public int saveOrderWithOptions(String sessionId, OrderIf order, int languageId, SaveOrderOptionsIf options) throws KKException
     {
         try
         {
            if (_saveOrderWithOptions == null)
            {
                _saveOrderWithOptions = new SaveOrderWithOptions(kkEng);
            }

            return _saveOrderWithOptions.saveOrderWithOptions(sessionId, order, languageId, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * no TagGroup objects exist. If the categoryId is set to -1 then all TagGroups are returned.
     * 
     * @param categoryId
     *            The numeric id of the category. If set to -1 then all TagGroups are returned.
     * @param getProdCount
     ...
     * </ul>
     * An empty array is returned if no TagGroup objects exist. If the categoryId is set to -1 then
     * all TagGroups are returned.
     * 
     * @param categoryId
     *            The numeric id of the category. If set to -1 then all TagGroups are returned.
     * @param languageId
     ...
     * exist. The Tags are sorted first by sort order and then by name. If the categoryId is set to
     * -1 then all tags are returned.
     * 
     * @param categoryId
     *            The numeric id of the category. If set to -1 then all tags are returned.
     * @param getProdCount
     ...
     *            The id for the language that will be used. Value of -1 selects the default
     *            language.
     * @return Returns a WishListIf object that contains an array of WishListItem objects
     * @throws KKException
     */
     ...
     * thrown if a customer doesn't exist for the customer id found in the token.
     * <p>
     ...
     * then the <code>emailVerified</code> attribute of the customer is also set. If the customer is
     * enabled during registration, this API call may still be used to set the
     * <code>emailVerified</code> attribute when a customer clicks the link in the email.
     * 
     * @param secretKey
     * @throws KKException
     */
     ...
     * not within the start and end dates of the promotion, or if it has reached its max usage then
     * it is not returned. Also if an OrderTotal module is not installed, then none of the
     * promotions for that OrderTotal module are returned.
     * 
     ...
     *            </ul>
     * @return search results in a ContentSearchResultIf object. If there are no content objects to
     *         return an empty Contents array is returned and not a null.
     * @throws KKException
     */
    ...
    /**
     * Returns a catalog object for the catalog key. Null is returned if the catalog is not found.
     * 
     * @param catalogKey
     *            The key identifying the catalog. Note that this is a semantic key and not the
     *            numeric catalog id.
     * @return Returns a catalog object for the catalog key
     * @throws KKException
     */
     public CatalogIf getCatalogPerKey(String catalogKey) throws KKException
     {
         try
         {
            if (_getCatalogPerKey == null)
            {
                _getCatalogPerKey = new GetCatalogPerKey(kkEng);
            }

            return _getCatalogPerKey.getCatalogPerKey(catalogKey);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Used to change the password of a customer. The
     * <code>sendNewPassword1(String emailAddr, EmailOptionsIf options)</code> API call generates a
     ...
     * 
     * @param adminSession
     *            The session id of an administrator
     * @param customerEmailAddr
     *            The email address of the customer
     * @param customerId
     *            The id of the customer. Only used if customerEmailAddr is null
     * @param newPassword
     *            The new password
     * @throws KKException
     */
     public void setNewPassword(String adminSession, String customerEmailAddr, int customerId, String newPassword) throws KKException
     {
         try
         {
            if (_setNewPassword == null)
            {
                _setNewPassword = new SetNewPassword(kkEng);
            }

            _setNewPassword.setNewPassword(adminSession, customerEmailAddr, customerId, newPassword);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Inserts a CreditCard object into the database. The customer must be logged in with a valid
     * session id. The id of the logged in customer is written into the customerId attribute of the
     * CreditCard object before it is saved.
     * <p>
     * This API call is intended for saving tokenized (or vaulted) cards where the CreditCard object
     * doesn't contain any sensitive card information. It should just contain the token returned
     * from the payment gateway as well as a few digits of the card number and maybe the expiration
     * date in order to detect that the card has expired. No encryption is performed.
     * 
     * @param sessionId
     *            The session id of the logged in user
     * @param card
     *            A CreditCard object
     * @param options
     *            CreditCardOptions not currently used
     * @return Returns the id of the inserted object
     * @throws Exception
     */
     public int addCreditCardToCustomer(String sessionId, CreditCardIf card, CreditCardOptionsIf options) throws Exception
     {
         try
         {
            if (_addCreditCardToCustomer == null)
            {
                _addCreditCardToCustomer = new AddCreditCardToCustomer(kkEng);
            }

            return _addCreditCardToCustomer.addCreditCardToCustomer(sessionId, card, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Get an array of CreditCard objects for a logged in customer. An empty array is returned if
     * there are no cards.
     * 
     * @param sessionId
     *            The session id of the logged in user
     ...
     *            populated
     * @return Returns an array of CreditCard objects
     * @throws Exception
     */
     public CreditCardIf[] getCreditCardsPerCustomer(String sessionId, CreditCardOptionsIf options) throws Exception
     {
         try
         {
            if (_getCreditCardsPerCustomer == null)
            {
                _getCreditCardsPerCustomer = new GetCreditCardsPerCustomer(kkEng);
            }

            return _getCreditCardsPerCustomer.getCreditCardsPerCustomer(sessionId, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     *            The session id of the logged in user
     * @param cardId
     *            The id of the CreditCard object to delete
     * @throws Exception
     */
     public void deleteCreditCard(String sessionId, int cardId) throws Exception
     {
         try
         {
            if (_deleteCreditCard == null)
            {
                _deleteCreditCard = new DeleteCreditCard(kkEng);
            }

            _deleteCreditCard.deleteCreditCard(sessionId, cardId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Edit the CreditCard object of a logged in customer referenced by sessionId. The existing card
     ...
     */
     public void editCreditCard(String sessionId, CreditCardIf card, CreditCardOptionsIf options) throws Exception
     {
         try
         {
            if (_editCreditCard == null)
            {
                _editCreditCard = new EditCreditCard(kkEng);
            }

            _editCreditCard.editCreditCard(sessionId, card, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
