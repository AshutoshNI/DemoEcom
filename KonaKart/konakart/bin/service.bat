...
set DISPLAYNAME=KonaKart on Tomcat
set PR_DISPLAYNAME=KonaKart on Apache Tomcat 8.0.26 - http://www.konakart.com/
...
if "x%1x" == "x--userx" goto runAsUser
set SERVICE_NAME=%1
set DISPLAYNAME=KonaKart on Tomcat 8.0.26
shift
if "x%1x" == "xx" goto checkServiceCmd
goto checkUser
:runAsUser
